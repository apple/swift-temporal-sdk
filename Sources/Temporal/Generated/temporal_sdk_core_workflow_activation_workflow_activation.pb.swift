...
extension Coresdk.WorkflowActivation {
  ...
  /// list.
  package struct WorkflowActivation: Sendable {
    ...
    package var hasTimestamp: Bool {self._timestamp != nil}
    ...
    package var jobs: [Coresdk.WorkflowActivation.WorkflowActivationJob] = []
    ...
    /// feature(s).
    package var deploymentVersionForCurrentTask: Coresdk.Common.WorkerDeploymentVersion {
      get {_deploymentVersionForCurrentTask ?? Coresdk.Common.WorkerDeploymentVersion()}
      set {_deploymentVersionForCurrentTask = newValue}
    }
    /// Returns true if `deploymentVersionForCurrentTask` has been explicitly set.
    package var hasDeploymentVersionForCurrentTask: Bool {self._deploymentVersionForCurrentTask != nil}
    ...
    package var lastSdkVersion: String = String()
    ...
    fileprivate var _deploymentVersionForCurrentTask: Coresdk.Common.WorkerDeploymentVersion? = nil
  }
}
extension Coresdk.WorkflowActivation {


  package struct WorkflowActivationJob: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    package var variant: Coresdk.WorkflowActivation.WorkflowActivationJob.OneOf_Variant? = nil

    /// A workflow is starting, record all of the information from its start event
    package var initializeWorkflow: Coresdk.WorkflowActivation.InitializeWorkflow {
      get {
        if case .initializeWorkflow(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.InitializeWorkflow()
      }
      set {variant = .initializeWorkflow(newValue)}
    }

    /// A timer has fired, allowing whatever was waiting on it (if anything) to proceed
    package var fireTimer: Coresdk.WorkflowActivation.FireTimer {
      get {
        if case .fireTimer(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.FireTimer()
      }
      set {variant = .fireTimer(newValue)}
    }

    /// Workflow was reset. The randomness seed must be updated.
    package var updateRandomSeed: Coresdk.WorkflowActivation.UpdateRandomSeed {
      get {
        if case .updateRandomSeed(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.UpdateRandomSeed()
      }
    ...
    package var queryWorkflow: Coresdk.WorkflowActivation.QueryWorkflow {
      get {
        if case .queryWorkflow(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.QueryWorkflow()
      }
      set {variant = .queryWorkflow(newValue)}
    }

    /// A request to cancel the workflow was received.
    package var cancelWorkflow: Coresdk.WorkflowActivation.CancelWorkflow {
      get {
        if case .cancelWorkflow(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.CancelWorkflow()
      }
      set {variant = .cancelWorkflow(newValue)}
    }

    /// A request to signal the workflow was received.
    package var signalWorkflow: Coresdk.WorkflowActivation.SignalWorkflow {
      get {
        if case .signalWorkflow(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.SignalWorkflow()
      }
      set {variant = .signalWorkflow(newValue)}
    }

    /// An activity was resolved, result could be completed, failed or cancelled
    package var resolveActivity: Coresdk.WorkflowActivation.ResolveActivity {
      get {
        if case .resolveActivity(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.ResolveActivity()
      }
    ...
    package var notifyHasPatch: Coresdk.WorkflowActivation.NotifyHasPatch {
      get {
        if case .notifyHasPatch(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.NotifyHasPatch()
      }
      set {variant = .notifyHasPatch(newValue)}
    }

    /// A child workflow execution has started or failed to start
    package var resolveChildWorkflowExecutionStart: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart {
      get {
        if case .resolveChildWorkflowExecutionStart(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart()
      }
      set {variant = .resolveChildWorkflowExecutionStart(newValue)}
    }

    /// A child workflow was resolved, result could be completed or failed
    package var resolveChildWorkflowExecution: Coresdk.WorkflowActivation.ResolveChildWorkflowExecution {
      get {
        if case .resolveChildWorkflowExecution(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.ResolveChildWorkflowExecution()
      }
      set {variant = .resolveChildWorkflowExecution(newValue)}
    }

    /// An attempt to signal an external workflow resolved
    package var resolveSignalExternalWorkflow: Coresdk.WorkflowActivation.ResolveSignalExternalWorkflow {
      get {
        if case .resolveSignalExternalWorkflow(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.ResolveSignalExternalWorkflow()
      }
      set {variant = .resolveSignalExternalWorkflow(newValue)}
    }

    /// An attempt to cancel an external workflow resolved
    package var resolveRequestCancelExternalWorkflow: Coresdk.WorkflowActivation.ResolveRequestCancelExternalWorkflow {
      get {
        if case .resolveRequestCancelExternalWorkflow(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.ResolveRequestCancelExternalWorkflow()
      }
      set {variant = .resolveRequestCancelExternalWorkflow(newValue)}
    }

    /// A request to handle a workflow update.
    package var doUpdate: Coresdk.WorkflowActivation.DoUpdate {
      get {
        if case .doUpdate(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.DoUpdate()
      }
      set {variant = .doUpdate(newValue)}
    }

    /// A nexus operation started.
    package var resolveNexusOperationStart: Coresdk.WorkflowActivation.ResolveNexusOperationStart {
      get {
        if case .resolveNexusOperationStart(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.ResolveNexusOperationStart()
      }
      set {variant = .resolveNexusOperationStart(newValue)}
    }

    /// A nexus operation resolved.
    package var resolveNexusOperation: Coresdk.WorkflowActivation.ResolveNexusOperation {
      get {
        if case .resolveNexusOperation(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.ResolveNexusOperation()
      }
    ...
    package var removeFromCache: Coresdk.WorkflowActivation.RemoveFromCache {
      get {
        if case .removeFromCache(let v)? = variant {return v}
        return Coresdk.WorkflowActivation.RemoveFromCache()
      }
    ...
    package enum OneOf_Variant: Equatable, Sendable {
      /// A workflow is starting, record all of the information from its start event
      case initializeWorkflow(Coresdk.WorkflowActivation.InitializeWorkflow)
      /// A timer has fired, allowing whatever was waiting on it (if anything) to proceed
      case fireTimer(Coresdk.WorkflowActivation.FireTimer)
      /// Workflow was reset. The randomness seed must be updated.
      case updateRandomSeed(Coresdk.WorkflowActivation.UpdateRandomSeed)
      /// A request to query the workflow was received. It is guaranteed that queries (one or more)
      /// always come in their own activation after other mutating jobs.
      case queryWorkflow(Coresdk.WorkflowActivation.QueryWorkflow)
      /// A request to cancel the workflow was received.
      case cancelWorkflow(Coresdk.WorkflowActivation.CancelWorkflow)
      /// A request to signal the workflow was received.
      case signalWorkflow(Coresdk.WorkflowActivation.SignalWorkflow)
      /// An activity was resolved, result could be completed, failed or cancelled
      case resolveActivity(Coresdk.WorkflowActivation.ResolveActivity)
      /// A patch marker has been detected and lang is being told that change exists. This
      /// job is strange in that it is sent pre-emptively to lang without any corresponding
      /// command being sent first.
      case notifyHasPatch(Coresdk.WorkflowActivation.NotifyHasPatch)
      /// A child workflow execution has started or failed to start
      case resolveChildWorkflowExecutionStart(Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart)
      /// A child workflow was resolved, result could be completed or failed
      case resolveChildWorkflowExecution(Coresdk.WorkflowActivation.ResolveChildWorkflowExecution)
      /// An attempt to signal an external workflow resolved
      case resolveSignalExternalWorkflow(Coresdk.WorkflowActivation.ResolveSignalExternalWorkflow)
      /// An attempt to cancel an external workflow resolved
      case resolveRequestCancelExternalWorkflow(Coresdk.WorkflowActivation.ResolveRequestCancelExternalWorkflow)
      /// A request to handle a workflow update.
      case doUpdate(Coresdk.WorkflowActivation.DoUpdate)
      /// A nexus operation started.
      case resolveNexusOperationStart(Coresdk.WorkflowActivation.ResolveNexusOperationStart)
      /// A nexus operation resolved.
      case resolveNexusOperation(Coresdk.WorkflowActivation.ResolveNexusOperation)
      /// Remove the workflow identified by the [WorkflowActivation] containing this job from the
      /// cache after performing the activation. It is guaranteed that this will be the only job
      /// in the activation if present.
      case removeFromCache(Coresdk.WorkflowActivation.RemoveFromCache)
...
extension Coresdk.WorkflowActivation {
  ...
  package struct InitializeWorkflow: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var parentWorkflowInfo: Coresdk.Common.NamespacedWorkflowExecution {
      get {_storage._parentWorkflowInfo ?? Coresdk.Common.NamespacedWorkflowExecution()}
      set {_uniqueStorage()._parentWorkflowInfo = newValue}
    }
    /// Returns true if `parentWorkflowInfo` has been explicitly set.
    package var hasParentWorkflowInfo: Bool {_storage._parentWorkflowInfo != nil}
    ...
    package var continuedFromExecutionRunID: String {
      get {_storage._continuedFromExecutionRunID}
    ...
    package var continuedInitiator: Api.Enums.V1.ContinueAsNewInitiator {
      get {_storage._continuedInitiator}
    ...
    package var cronScheduleToScheduleInterval: SwiftProtobuf.Google_Protobuf_Duration {
      get {_storage._cronScheduleToScheduleInterval ?? SwiftProtobuf.Google_Protobuf_Duration()}
    ...
    package var hasCronScheduleToScheduleInterval: Bool {_storage._cronScheduleToScheduleInterval != nil}
    ...
    package var hasStartTime: Bool {_storage._startTime != nil}
    ...
    package var rootWorkflow: Api.Common.V1.WorkflowExecution {
      get {_storage._rootWorkflow ?? Api.Common.V1.WorkflowExecution()}
      set {_uniqueStorage()._rootWorkflow = newValue}
    }
    /// Returns true if `rootWorkflow` has been explicitly set.
    package var hasRootWorkflow: Bool {_storage._rootWorkflow != nil}
...
extension Coresdk.WorkflowActivation {
  ...
  package struct FireTimer: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveActivity: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var result: Coresdk.ActivityResult.ActivityResolution {
      get {_result ?? Coresdk.ActivityResult.ActivityResolution()}
    ...
    fileprivate var _result: Coresdk.ActivityResult.ActivityResolution? = nil
  }
}
extension Coresdk.WorkflowActivation {
  ...
  /// cancelled.
  package struct ResolveChildWorkflowExecutionStart: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var status: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart.OneOf_Status? = nil

    package var succeeded: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartSuccess {
      get {
        if case .succeeded(let v)? = status {return v}
        return Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartSuccess()
      }
      set {status = .succeeded(newValue)}
    }

    package var failed: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartFailure {
      get {
        if case .failed(let v)? = status {return v}
        return Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartFailure()
      }
      set {status = .failed(newValue)}
    }

    package var cancelled: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartCancelled {
      get {
        if case .cancelled(let v)? = status {return v}
        return Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartCancelled()
      }
    ...
    package enum OneOf_Status: Equatable, Sendable {
      case succeeded(Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartSuccess)
      case failed(Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartFailure)
      case cancelled(Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartCancelled)
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveChildWorkflowExecutionStartSuccess: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveChildWorkflowExecutionStartFailure: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var cause: Coresdk.ChildWorkflow.StartChildWorkflowExecutionFailedCause = .unspecified
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveChildWorkflowExecutionStartCancelled: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveChildWorkflowExecution: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var result: Coresdk.ChildWorkflow.ChildWorkflowResult {
      get {_result ?? Coresdk.ChildWorkflow.ChildWorkflowResult()}
      set {_result = newValue}
    }
    /// Returns true if `result` has been explicitly set.
    package var hasResult: Bool {self._result != nil}
    ...
    fileprivate var _result: Coresdk.ChildWorkflow.ChildWorkflowResult? = nil
  }
}
extension Coresdk.WorkflowActivation {
  ...
  package struct UpdateRandomSeed: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  /// Query a workflow
  package struct QueryWorkflow: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct CancelWorkflow: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct NotifyHasPatch: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveSignalExternalWorkflow: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveRequestCancelExternalWorkflow: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct DoUpdate: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveNexusOperationStart: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var status: Coresdk.WorkflowActivation.ResolveNexusOperationStart.OneOf_Status? = nil
...
extension Coresdk.WorkflowActivation {
  ...
  package struct ResolveNexusOperation: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var result: Coresdk.Nexus.NexusOperationResult {
      get {_result ?? Coresdk.Nexus.NexusOperationResult()}
      set {_result = newValue}
    }
    /// Returns true if `result` has been explicitly set.
    package var hasResult: Bool {self._result != nil}
    ...
    fileprivate var _result: Coresdk.Nexus.NexusOperationResult? = nil
  }
}
extension Coresdk.WorkflowActivation {


  package struct RemoveFromCache: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var reason: Coresdk.WorkflowActivation.RemoveFromCache.EvictionReason = .unspecified
    ...
    package enum EvictionReason: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      package static let allCases: [Coresdk.WorkflowActivation.RemoveFromCache.EvictionReason] = [
        .unspecified,
        .cacheFull,
        .cacheMiss,
        .nondeterminism,
...
extension Coresdk.WorkflowActivation.WorkflowActivation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.lastSdkVersion.isEmpty {
      try visitor.visitSingularStringField(value: self.lastSdkVersion, fieldNumber: 10)
    }
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.WorkflowActivation, rhs: Coresdk.WorkflowActivation.WorkflowActivation) -> Bool {
...
extension Coresdk.WorkflowActivation.WorkflowActivationJob: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Coresdk.WorkflowActivation.InitializeWorkflow?
      ...
      case 2: try {
        var v: Coresdk.WorkflowActivation.FireTimer?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 4: try {
        var v: Coresdk.WorkflowActivation.UpdateRandomSeed?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 5: try {
        var v: Coresdk.WorkflowActivation.QueryWorkflow?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 6: try {
        var v: Coresdk.WorkflowActivation.CancelWorkflow?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 7: try {
        var v: Coresdk.WorkflowActivation.SignalWorkflow?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 8: try {
        var v: Coresdk.WorkflowActivation.ResolveActivity?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 9: try {
        var v: Coresdk.WorkflowActivation.NotifyHasPatch?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 10: try {
        var v: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 11: try {
        var v: Coresdk.WorkflowActivation.ResolveChildWorkflowExecution?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 12: try {
        var v: Coresdk.WorkflowActivation.ResolveSignalExternalWorkflow?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 13: try {
        var v: Coresdk.WorkflowActivation.ResolveRequestCancelExternalWorkflow?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 14: try {
        var v: Coresdk.WorkflowActivation.DoUpdate?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 15: try {
        var v: Coresdk.WorkflowActivation.ResolveNexusOperationStart?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 16: try {
        var v: Coresdk.WorkflowActivation.ResolveNexusOperation?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
      ...
      case 50: try {
        var v: Coresdk.WorkflowActivation.RemoveFromCache?
        var hadOneofValue = false
        if let current = self.variant {
          hadOneofValue = true
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.WorkflowActivationJob, rhs: Coresdk.WorkflowActivation.WorkflowActivationJob) -> Bool {
...
extension Coresdk.WorkflowActivation.InitializeWorkflow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _parentWorkflowInfo: Coresdk.Common.NamespacedWorkflowExecution? = nil
    ...
    var _continuedInitiator: Api.Enums.V1.ContinueAsNewInitiator = .unspecified
    ...
    var _rootWorkflow: Api.Common.V1.WorkflowExecution? = nil
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 5: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: &_storage._headers) }()
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._headers.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: _storage._headers, fieldNumber: 5)
      }
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.InitializeWorkflow, rhs: Coresdk.WorkflowActivation.InitializeWorkflow) -> Bool {
...
extension Coresdk.WorkflowActivation.FireTimer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.FireTimer, rhs: Coresdk.WorkflowActivation.FireTimer) -> Bool {
...
extension Coresdk.WorkflowActivation.ResolveActivity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveActivity, rhs: Coresdk.WorkflowActivation.ResolveActivity) -> Bool {
    if lhs.seq != rhs.seq {return false}
...
extension Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.seq) }()
      case 2: try {
        var v: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartSuccess?
        var hadOneofValue = false
      ...
      case 3: try {
        var v: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartFailure?
        var hadOneofValue = false
        if let current = self.status {
          hadOneofValue = true
      ...
      case 4: try {
        var v: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartCancelled?
        var hadOneofValue = false
        if let current = self.status {
          hadOneofValue = true
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart, rhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStart) -> Bool {
    if lhs.seq != rhs.seq {return false}
...
extension Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartSuccess: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartSuccess, rhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartSuccess) -> Bool {
    if lhs.runID != rhs.runID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartFailure: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartFailure, rhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartFailure) -> Bool {
...
extension Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartCancelled: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartCancelled, rhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecutionStartCancelled) -> Bool {
...
extension Coresdk.WorkflowActivation.ResolveChildWorkflowExecution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecution, rhs: Coresdk.WorkflowActivation.ResolveChildWorkflowExecution) -> Bool {
    if lhs.seq != rhs.seq {return false}
    if lhs._result != rhs._result {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Coresdk.WorkflowActivation.UpdateRandomSeed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.UpdateRandomSeed, rhs: Coresdk.WorkflowActivation.UpdateRandomSeed) -> Bool {
...
extension Coresdk.WorkflowActivation.QueryWorkflow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: &self.headers) }()
      default: break
      }
    }
  }
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.headers.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: self.headers, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  package static func ==(lhs: Coresdk.WorkflowActivation.QueryWorkflow, rhs: Coresdk.WorkflowActivation.QueryWorkflow) -> Bool {
...
extension Coresdk.WorkflowActivation.CancelWorkflow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.CancelWorkflow, rhs: Coresdk.WorkflowActivation.CancelWorkflow) -> Bool {
...
extension Coresdk.WorkflowActivation.SignalWorkflow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.SignalWorkflow, rhs: Coresdk.WorkflowActivation.SignalWorkflow) -> Bool {
...
extension Coresdk.WorkflowActivation.NotifyHasPatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.NotifyHasPatch, rhs: Coresdk.WorkflowActivation.NotifyHasPatch) -> Bool {
...
extension Coresdk.WorkflowActivation.ResolveSignalExternalWorkflow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveSignalExternalWorkflow, rhs: Coresdk.WorkflowActivation.ResolveSignalExternalWorkflow) -> Bool {
    if lhs.seq != rhs.seq {return false}
    if lhs._failure != rhs._failure {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Coresdk.WorkflowActivation.ResolveRequestCancelExternalWorkflow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveRequestCancelExternalWorkflow, rhs: Coresdk.WorkflowActivation.ResolveRequestCancelExternalWorkflow) -> Bool {
    if lhs.seq != rhs.seq {return false}
    if lhs._failure != rhs._failure {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Coresdk.WorkflowActivation.DoUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.DoUpdate, rhs: Coresdk.WorkflowActivation.DoUpdate) -> Bool {
...
extension Coresdk.WorkflowActivation.ResolveNexusOperationStart: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveNexusOperationStart, rhs: Coresdk.WorkflowActivation.ResolveNexusOperationStart) -> Bool {
    if lhs.seq != rhs.seq {return false}
    if lhs.status != rhs.status {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Coresdk.WorkflowActivation.ResolveNexusOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.ResolveNexusOperation, rhs: Coresdk.WorkflowActivation.ResolveNexusOperation) -> Bool {
    if lhs.seq != rhs.seq {return false}
    if lhs._result != rhs._result {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Coresdk.WorkflowActivation.RemoveFromCache: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowActivation.RemoveFromCache, rhs: Coresdk.WorkflowActivation.RemoveFromCache) -> Bool {
...
extension Coresdk.WorkflowActivation.RemoveFromCache.EvictionReason: SwiftProtobuf._ProtoNameProviding {
