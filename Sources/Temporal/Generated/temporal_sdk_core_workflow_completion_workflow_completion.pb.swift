...
extension Coresdk.WorkflowCompletion {


  /// Result of a single workflow activation, reported from lang to core
  package struct WorkflowActivationCompletion: Sendable {
    ...
    package var status: Coresdk.WorkflowCompletion.WorkflowActivationCompletion.OneOf_Status? = nil

    package var successful: Coresdk.WorkflowCompletion.Success {
      get {
        if case .successful(let v)? = status {return v}
        return Coresdk.WorkflowCompletion.Success()
      }
      set {status = .successful(newValue)}
    }

    package var failed: Coresdk.WorkflowCompletion.Failure {
      get {
        if case .failed(let v)? = status {return v}
        return Coresdk.WorkflowCompletion.Failure()
      }
    ...
    package enum OneOf_Status: Equatable, Sendable {
      case successful(Coresdk.WorkflowCompletion.Success)
      case failed(Coresdk.WorkflowCompletion.Failure)
...
extension Coresdk.WorkflowCompletion {
  ...
  package struct Success: Sendable {
    ...
    package var commands: [Coresdk.WorkflowCommands.WorkflowCommand] = []
    ...
    package var versioningBehavior: Api.Enums.V1.VersioningBehavior = .unspecified
...
extension Coresdk.WorkflowCompletion {
  ...
  package struct Failure: Sendable {
    ...
    package var forceCause: Api.Enums.V1.WorkflowTaskFailedCause = .unspecified
...
extension Coresdk.WorkflowCompletion.WorkflowActivationCompletion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Coresdk.WorkflowCompletion.Success?
      ...
      case 3: try {
        var v: Coresdk.WorkflowCompletion.Failure?
        var hadOneofValue = false
        if let current = self.status {
          hadOneofValue = true
  ...
  package static func ==(lhs: Coresdk.WorkflowCompletion.WorkflowActivationCompletion, rhs: Coresdk.WorkflowCompletion.WorkflowActivationCompletion) -> Bool {
...
extension Coresdk.WorkflowCompletion.Success: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowCompletion.Success, rhs: Coresdk.WorkflowCompletion.Success) -> Bool {
...
extension Coresdk.WorkflowCompletion.Failure: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.WorkflowCompletion.Failure, rhs: Coresdk.WorkflowCompletion.Failure) -> Bool {
