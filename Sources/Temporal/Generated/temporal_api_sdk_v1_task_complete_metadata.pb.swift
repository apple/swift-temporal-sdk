...
extension Api.Sdk.V1 {
  ...
  package struct WorkflowTaskCompletedMetadata: Sendable {
...
extension Api.Sdk.V1.WorkflowTaskCompletedMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Sdk.V1.WorkflowTaskCompletedMetadata, rhs: Api.Sdk.V1.WorkflowTaskCompletedMetadata) -> Bool {
