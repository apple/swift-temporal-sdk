...
extension Api.Enums.V1 {
  ...
  public enum NexusHandlerErrorRetryBehavior: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Api.Enums.V1.NexusHandlerErrorRetryBehavior] = [
      .unspecified,
      .retryable,
      .nonRetryable,
    ]
...
extension Api.Enums.V1.NexusHandlerErrorRetryBehavior: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NEXUS_HANDLER_ERROR_RETRY_BEHAVIOR_UNSPECIFIED\0\u{1}NEXUS_HANDLER_ERROR_RETRY_BEHAVIOR_RETRYABLE\0\u{1}NEXUS_HANDLER_ERROR_RETRY_BEHAVIOR_NON_RETRYABLE\0")
}
