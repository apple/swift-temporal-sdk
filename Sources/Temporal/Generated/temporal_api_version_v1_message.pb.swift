...
extension Api.Version.V1 {
  ...
  package struct ReleaseInfo: Sendable {
    ...
    package var hasReleaseTime: Bool {self._releaseTime != nil}
...
extension Api.Version.V1 {
  ...
  package struct Alert: Sendable {
    ...
    package var severity: Api.Enums.V1.Severity = .unspecified
...
extension Api.Version.V1 {
  ...
  package struct VersionInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    package var current: Api.Version.V1.ReleaseInfo {
      get {_current ?? Api.Version.V1.ReleaseInfo()}
      set {_current = newValue}
    }
    /// Returns true if `current` has been explicitly set.
    package var hasCurrent: Bool {self._current != nil}
    ...
    package var alerts: [Api.Version.V1.Alert] = []
...
extension Api.Version.V1.ReleaseInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Version.V1.ReleaseInfo, rhs: Api.Version.V1.ReleaseInfo) -> Bool {
...
extension Api.Version.V1.Alert: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Version.V1.Alert, rhs: Api.Version.V1.Alert) -> Bool {
...
extension Api.Version.V1.VersionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Version.V1.VersionInfo, rhs: Api.Version.V1.VersionInfo) -> Bool {
