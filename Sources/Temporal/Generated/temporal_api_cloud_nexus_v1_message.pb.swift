...
extension Api.Cloud.Nexus.V1 {
  ...
  package struct EndpointSpec: Sendable {
    ...
    package var targetSpec: Api.Cloud.Nexus.V1.EndpointTargetSpec {
    ...
    package var hasTargetSpec: Bool {self._targetSpec != nil}
    ...
    /// This field is mutable.
    package var policySpecs: [Api.Cloud.Nexus.V1.EndpointPolicySpec] = []
...
extension Api.Cloud.Nexus.V1 {
  ...
  package struct EndpointTargetSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    package var variant: Api.Cloud.Nexus.V1.EndpointTargetSpec.OneOf_Variant? = nil

    /// A target spec for routing nexus requests to a specific cloud namespace worker.
    package var workerTargetSpec: Api.Cloud.Nexus.V1.WorkerTargetSpec {
      get {
...
extension Api.Cloud.Nexus.V1 {
  ...
  package struct WorkerTargetSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Cloud.Nexus.V1 {
  ...
  package struct EndpointPolicySpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    package var variant: Api.Cloud.Nexus.V1.EndpointPolicySpec.OneOf_Variant? = nil

    /// A policy spec that allows one caller namespace to access the endpoint.
    package var allowedCloudNamespacePolicySpec: Api.Cloud.Nexus.V1.AllowedCloudNamespacePolicySpec {
      get {
...
extension Api.Cloud.Nexus.V1 {
  ...
  package struct AllowedCloudNamespacePolicySpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Cloud.Nexus.V1.EndpointSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Nexus.V1.EndpointSpec, rhs: Api.Cloud.Nexus.V1.EndpointSpec) -> Bool {
...
extension Api.Cloud.Nexus.V1.EndpointTargetSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Nexus.V1.EndpointTargetSpec, rhs: Api.Cloud.Nexus.V1.EndpointTargetSpec) -> Bool {
...
extension Api.Cloud.Nexus.V1.WorkerTargetSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Nexus.V1.WorkerTargetSpec, rhs: Api.Cloud.Nexus.V1.WorkerTargetSpec) -> Bool {
...
extension Api.Cloud.Nexus.V1.EndpointPolicySpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Nexus.V1.EndpointPolicySpec, rhs: Api.Cloud.Nexus.V1.EndpointPolicySpec) -> Bool {
    if lhs.variant != rhs.variant {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Api.Cloud.Nexus.V1.AllowedCloudNamespacePolicySpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Nexus.V1.AllowedCloudNamespacePolicySpec, rhs: Api.Cloud.Nexus.V1.AllowedCloudNamespacePolicySpec) -> Bool {
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Api.Cloud.Nexus.V1.Endpoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Nexus.V1.Endpoint, rhs: Api.Cloud.Nexus.V1.Endpoint) -> Bool {
