...
extension Api.Cloud.Region.V1 {
  ...
  package struct Region: Sendable {
    ...
    package var cloudProvider: Api.Cloud.Region.V1.Region.CloudProvider = .unspecified
    ...
    package enum CloudProvider: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      package static let allCases: [Api.Cloud.Region.V1.Region.CloudProvider] = [
        .unspecified,
        .aws,
        .gcp,
      ]
...
extension Api.Cloud.Region.V1.Region: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Region.V1.Region, rhs: Api.Cloud.Region.V1.Region) -> Bool {
