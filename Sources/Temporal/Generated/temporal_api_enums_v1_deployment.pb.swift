...
extension Api.Enums.V1 {
  ...
  package enum DeploymentReachability: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    package static let allCases: [Api.Enums.V1.DeploymentReachability] = [
      .unspecified,
      .reachable,
      .closedWorkflowsOnly,
      .unreachable,
...
extension Api.Enums.V1 {
  ...
  package enum VersionDrainageStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Api.Enums.V1.VersionDrainageStatus] = [
      .unspecified,
      .draining,
      .drained,
    ]
...
extension Api.Enums.V1 {
  ...
  /// Experimental. Worker Deployments are experimental and might significantly change in the future.
  package enum WorkerVersioningMode: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int
    case unspecified // = 0
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Api.Enums.V1.WorkerVersioningMode] = [
      .unspecified,
      .unversioned,
      .versioned,
    ]
...
extension Api.Enums.V1 {
  ...
  /// Experimental. Worker Deployments are experimental and might significantly change in the future.
  package enum WorkerDeploymentVersionStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int
    case unspecified // = 0
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Api.Enums.V1.WorkerDeploymentVersionStatus] = [
      .unspecified,
      .inactive,
      .current,
      .ramping,
