...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueue: Sendable {
    ...
    public var kind: Api.Enums.V1.TaskQueueKind = .unspecified

    /// Iff kind == TASK_QUEUE_KIND_STICKY, then this field contains the name of
    /// the normal task queue that the sticky worker is running on.
    public var normalName: String = String()
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueMetadata: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Allows throttling dispatch of tasks from this queue
    public var maxTasksPerSecond: SwiftProtobuf.Google_Protobuf_DoubleValue {
    ...
    public var hasMaxTasksPerSecond: Bool {self._maxTasksPerSecond != nil}
    /// Clears the value of `maxTasksPerSecond`. Subsequent reads from it will return its default value.
    public mutating func clearMaxTasksPerSecond() {self._maxTasksPerSecond = nil}
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueVersioningInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueVersionSelection: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var unversioned: Bool = false
    ...
    public var allActive: Bool = false
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueVersionInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Task Queue info per Task Type. Key is the numerical value of the temporal.api.enums.v1.TaskQueueType enum.
    public var typesInfo: Dictionary<Int32,Api.Taskqueue.V1.TaskQueueTypeInfo> = [:]
    ...
    public var taskReachability: Api.Enums.V1.BuildIdTaskReachability = .unspecified
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueTypeInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueStats: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    /// grows.
    public var approximateBacklogCount: Int64 = 0
    ...
    /// few seconds.
    public var approximateBacklogAge: SwiftProtobuf.Google_Protobuf_Duration {
    ...
    public var hasApproximateBacklogAge: Bool {self._approximateBacklogAge != nil}
    /// Clears the value of `approximateBacklogAge`. Subsequent reads from it will return its default value.
    public mutating func clearApproximateBacklogAge() {self._approximateBacklogAge = nil}
    ...
    ///   worker instance.
    public var tasksAddRate: Float = 0
    ...
    ///   workflow goes to a normal queue, and the rest workflow tasks go to the Sticky queue associated with a specific
    ///   worker instance.
    public var tasksDispatchRate: Float = 0
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueStatus: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var backlogCountHint: Int64 = 0

    public var readLevel: Int64 = 0

    public var ackLevel: Int64 = 0

    public var ratePerSecond: Double = 0

    public var taskIDBlock: Api.Taskqueue.V1.TaskIdBlock {
    ...
    public var hasTaskIDBlock: Bool {self._taskIDBlock != nil}
    /// Clears the value of `taskIDBlock`. Subsequent reads from it will return its default value.
    public mutating func clearTaskIDBlock() {self._taskIDBlock = nil}
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskIdBlock: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var startID: Int64 = 0

    public var endID: Int64 = 0
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueuePartitionMetadata: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var ownerHostName: String = String()
...
extension Api.Taskqueue.V1 {
  ...
  public struct PollerInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Taskqueue.V1 {
  ...
  public struct StickyExecutionAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var workerTaskQueue: Api.Taskqueue.V1.TaskQueue {
    ...
    public var hasWorkerTaskQueue: Bool {self._workerTaskQueue != nil}
    /// Clears the value of `workerTaskQueue`. Subsequent reads from it will return its default value.
    public mutating func clearWorkerTaskQueue() {self._workerTaskQueue = nil}
...
extension Api.Taskqueue.V1 {
  ...
  public struct CompatibleVersionSet: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueReachability: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var reachability: [Api.Enums.V1.TaskReachability] = []
...
extension Api.Taskqueue.V1 {
  ...
  public struct BuildIdReachability: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var taskQueueReachability: [Api.Taskqueue.V1.TaskQueueReachability] = []
...
extension Api.Taskqueue.V1 {
  ...
  public struct RampByPercentage: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Acceptable range is [0,100).
    public var rampPercentage: Float = 0
...
extension Api.Taskqueue.V1 {
  ...
  /// unversioned Worker.
  public struct BuildIdAssignmentRule: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var ramp: Api.Taskqueue.V1.BuildIdAssignmentRule.OneOf_Ramp? = nil

    /// This ramp is useful for gradual Blue/Green deployments (and similar)
    /// where you want to send a certain portion of the traffic to the target
    /// Build ID.
    public var percentageRamp: Api.Taskqueue.V1.RampByPercentage {
      get {
...
extension Api.Taskqueue.V1 {
  ...
  public struct CompatibleBuildIdRedirectRule: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Taskqueue.V1 {
  ...
  public struct TimestampedBuildIdAssignmentRule: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Taskqueue.V1 {
  ...
  public struct TimestampedCompatibleBuildIdRedirectRule: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Taskqueue.V1 {
  ...
  /// pollers.
  public struct PollerScalingDecision: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var pollRequestDeltaSuggestion: Int32 = 0
...
extension Api.Taskqueue.V1 {
  ...
  public struct ConfigMetadata: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var updateIdentity: String = String()
...
extension Api.Taskqueue.V1 {
  ...
  public struct RateLimitConfig: Sendable {
    ...
    public var metadata: Api.Taskqueue.V1.ConfigMetadata {
...
extension Api.Taskqueue.V1 {
  ...
  public struct TaskQueueConfig: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Unless modified, this is the system-defined rate limit.
    public var queueRateLimit: Api.Taskqueue.V1.RateLimitConfig {
    ...
    public var hasQueueRateLimit: Bool {self._queueRateLimit != nil}
    /// Clears the value of `queueRateLimit`. Subsequent reads from it will return its default value.
    public mutating func clearQueueRateLimit() {self._queueRateLimit = nil}

    /// If set, each individual fairness key will be limited to this rate, scaled by the weight of the fairness key.
    public var fairnessKeysRateLimitDefault: Api.Taskqueue.V1.RateLimitConfig {
    ...
    public var hasFairnessKeysRateLimitDefault: Bool {self._fairnessKeysRateLimitDefault != nil}
    /// Clears the value of `fairnessKeysRateLimitDefault`. Subsequent reads from it will return its default value.
    public mutating func clearFairnessKeysRateLimitDefault() {self._fairnessKeysRateLimitDefault = nil}

    /// If set, overrides the fairness weights for the corresponding fairness keys.
    public var fairnessWeightOverrides: Dictionary<String,Float> = [:]
...
extension Api.Taskqueue.V1.TaskQueue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}kind\0\u{3}normal_name\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueue, rhs: Api.Taskqueue.V1.TaskQueue) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueMetadata"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}max_tasks_per_second\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueMetadata, rhs: Api.Taskqueue.V1.TaskQueueMetadata) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueVersioningInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueVersioningInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}current_version\0\u{3}ramping_version\0\u{3}ramping_version_percentage\0\u{3}update_time\0\u{4}\u{3}current_deployment_version\0\u{4}\u{2}ramping_deployment_version\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueVersioningInfo, rhs: Api.Taskqueue.V1.TaskQueueVersioningInfo) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueVersionSelection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueVersionSelection"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}build_ids\0\u{1}unversioned\0\u{3}all_active\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueVersionSelection, rhs: Api.Taskqueue.V1.TaskQueueVersionSelection) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueVersionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueVersionInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}types_info\0\u{3}task_reachability\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueVersionInfo, rhs: Api.Taskqueue.V1.TaskQueueVersionInfo) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueTypeInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueTypeInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}pollers\0\u{1}stats\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueTypeInfo, rhs: Api.Taskqueue.V1.TaskQueueTypeInfo) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueStats"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}approximate_backlog_count\0\u{3}approximate_backlog_age\0\u{3}tasks_add_rate\0\u{3}tasks_dispatch_rate\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueStats, rhs: Api.Taskqueue.V1.TaskQueueStats) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueStatus"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}backlog_count_hint\0\u{3}read_level\0\u{3}ack_level\0\u{3}rate_per_second\0\u{3}task_id_block\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueStatus, rhs: Api.Taskqueue.V1.TaskQueueStatus) -> Bool {
...
extension Api.Taskqueue.V1.TaskIdBlock: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskIdBlock"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_id\0\u{3}end_id\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskIdBlock, rhs: Api.Taskqueue.V1.TaskIdBlock) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueuePartitionMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueuePartitionMetadata"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}key\0\u{3}owner_host_name\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueuePartitionMetadata, rhs: Api.Taskqueue.V1.TaskQueuePartitionMetadata) -> Bool {
...
extension Api.Taskqueue.V1.PollerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PollerInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}last_access_time\0\u{1}identity\0\u{3}rate_per_second\0\u{3}worker_version_capabilities\0\u{3}deployment_options\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.PollerInfo, rhs: Api.Taskqueue.V1.PollerInfo) -> Bool {
...
extension Api.Taskqueue.V1.StickyExecutionAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StickyExecutionAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}worker_task_queue\0\u{3}schedule_to_start_timeout\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.StickyExecutionAttributes, rhs: Api.Taskqueue.V1.StickyExecutionAttributes) -> Bool {
...
extension Api.Taskqueue.V1.CompatibleVersionSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CompatibleVersionSet"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}build_ids\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.CompatibleVersionSet, rhs: Api.Taskqueue.V1.CompatibleVersionSet) -> Bool {
    if lhs.buildIds != rhs.buildIds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Api.Taskqueue.V1.TaskQueueReachability: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TaskQueueReachability"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}task_queue\0\u{1}reachability\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueReachability, rhs: Api.Taskqueue.V1.TaskQueueReachability) -> Bool {
...
extension Api.Taskqueue.V1.BuildIdReachability: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".BuildIdReachability"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}build_id\0\u{3}task_queue_reachability\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.BuildIdReachability, rhs: Api.Taskqueue.V1.BuildIdReachability) -> Bool {
...
extension Api.Taskqueue.V1.RampByPercentage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RampByPercentage"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ramp_percentage\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.RampByPercentage, rhs: Api.Taskqueue.V1.RampByPercentage) -> Bool {
...
extension Api.Taskqueue.V1.BuildIdAssignmentRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".BuildIdAssignmentRule"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}target_build_id\0\u{4}\u{2}percentage_ramp\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.BuildIdAssignmentRule, rhs: Api.Taskqueue.V1.BuildIdAssignmentRule) -> Bool {
...
extension Api.Taskqueue.V1.CompatibleBuildIdRedirectRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CompatibleBuildIdRedirectRule"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}source_build_id\0\u{3}target_build_id\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.CompatibleBuildIdRedirectRule, rhs: Api.Taskqueue.V1.CompatibleBuildIdRedirectRule) -> Bool {
...
extension Api.Taskqueue.V1.TimestampedBuildIdAssignmentRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TimestampedBuildIdAssignmentRule"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}rule\0\u{3}create_time\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TimestampedBuildIdAssignmentRule, rhs: Api.Taskqueue.V1.TimestampedBuildIdAssignmentRule) -> Bool {
...
extension Api.Taskqueue.V1.TimestampedCompatibleBuildIdRedirectRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TimestampedCompatibleBuildIdRedirectRule"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}rule\0\u{3}create_time\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TimestampedCompatibleBuildIdRedirectRule, rhs: Api.Taskqueue.V1.TimestampedCompatibleBuildIdRedirectRule) -> Bool {
    if lhs._rule != rhs._rule {return false}
    if lhs._createTime != rhs._createTime {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.Taskqueue.V1.PollerScalingDecision: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PollerScalingDecision"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}poll_request_delta_suggestion\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.PollerScalingDecision, rhs: Api.Taskqueue.V1.PollerScalingDecision) -> Bool {
...
extension Api.Taskqueue.V1.RateLimit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}requests_per_second\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.RateLimit, rhs: Api.Taskqueue.V1.RateLimit) -> Bool {
...
extension Api.Taskqueue.V1.ConfigMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ConfigMetadata"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}reason\0\u{3}update_identity\0\u{3}update_time\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.ConfigMetadata, rhs: Api.Taskqueue.V1.ConfigMetadata) -> Bool {
...
extension Api.Taskqueue.V1.RateLimitConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RateLimitConfig"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}rate_limit\0\u{1}metadata\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.RateLimitConfig, rhs: Api.Taskqueue.V1.RateLimitConfig) -> Bool {
...
extension Api.Taskqueue.V1.TaskQueueConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}queue_rate_limit\0\u{3}fairness_keys_rate_limit_default\0\u{3}fairness_weight_overrides\0")
  ...
  public static func ==(lhs: Api.Taskqueue.V1.TaskQueueConfig, rhs: Api.Taskqueue.V1.TaskQueueConfig) -> Bool {
