...
extension Api.Sdk.V1 {
  ...
  public struct UserMetadata: Sendable {
    ...
    /// bytes by default.
    public var summary: Api.Common.V1.Payload {
...
extension Api.Sdk.V1.UserMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}summary\0\u{1}details\0")
  ...
  public static func ==(lhs: Api.Sdk.V1.UserMetadata, rhs: Api.Sdk.V1.UserMetadata) -> Bool {
