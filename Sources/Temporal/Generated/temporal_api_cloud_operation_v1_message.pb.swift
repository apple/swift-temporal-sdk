...
extension Api.Cloud.Operation.V1 {
  ...
  package struct AsyncOperation: Sendable {
    ...
    package var state: Api.Cloud.Operation.V1.AsyncOperation.State = .unspecified
    ...
    package var hasCheckDuration: Bool {self._checkDuration != nil}
    ...
    package var hasOperationInput: Bool {self._operationInput != nil}
    ...
    package var hasFinishedTime: Bool {self._finishedTime != nil}
    ...
    package enum State: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      package static let allCases: [Api.Cloud.Operation.V1.AsyncOperation.State] = [
        .unspecified,
        .pending,
        .inProgress,
        .failed,
...
extension Api.Cloud.Operation.V1.AsyncOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Cloud.Operation.V1.AsyncOperation, rhs: Api.Cloud.Operation.V1.AsyncOperation) -> Bool {
