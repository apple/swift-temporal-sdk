...
extension Coresdk.Common {
  ...
  package enum VersioningIntent: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    package static let allCases: [Coresdk.Common.VersioningIntent] = [
      .unspecified,
      .compatible,
      .default,
    ]
...
extension Coresdk.Common {
  ...
  package struct NamespacedWorkflowExecution: Sendable {
...
extension Coresdk.Common.VersioningIntent: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNSPECIFIED\0\u{1}COMPATIBLE\0\u{1}DEFAULT\0")
}

extension Coresdk.Common.NamespacedWorkflowExecution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.Common.NamespacedWorkflowExecution, rhs: Coresdk.Common.NamespacedWorkflowExecution) -> Bool {
...
extension Coresdk.Common.WorkerDeploymentVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Coresdk.Common.WorkerDeploymentVersion, rhs: Coresdk.Common.WorkerDeploymentVersion) -> Bool {
