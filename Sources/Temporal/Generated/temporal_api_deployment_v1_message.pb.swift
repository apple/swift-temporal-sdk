...
extension Api.Deployment.V1 {
  ...
  public struct WorkerDeploymentOptions: Sendable {
    ...
    public var workerVersioningMode: Api.Enums.V1.WorkerVersioningMode = .unspecified
...
extension Api.Deployment.V1 {
  ...
  public struct DeploymentInfo: Sendable {
    ...
    public var taskQueueInfos: [Api.Deployment.V1.DeploymentInfo.TaskQueueInfo] = []
    ...
    public var metadata: Dictionary<String,Api.Common.V1.Payload> = [:]
    ...
    public struct TaskQueueInfo: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
      ...
      public var firstPollerTime: SwiftProtobuf.Google_Protobuf_Timestamp {
        get {_firstPollerTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
        set {_firstPollerTime = newValue}
      }
      /// Returns true if `firstPollerTime` has been explicitly set.
      public var hasFirstPollerTime: Bool {self._firstPollerTime != nil}
      /// Clears the value of `firstPollerTime`. Subsequent reads from it will return its default value.
      public mutating func clearFirstPollerTime() {self._firstPollerTime = nil}
...
extension Api.Deployment.V1 {
  ...
  /// Deprecated.
  public struct UpdateDeploymentMetadata: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Deployment.V1 {
  ...
  /// ListDeployments.
  /// Deprecated.
  public struct DeploymentListInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Deployment.V1 {
  ...
  /// Experimental. Worker Deployments are experimental and might significantly change in the future.
  public struct WorkerDeploymentVersionInfo: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var status: Api.Enums.V1.WorkerDeploymentVersionStatus {
    ...
    public var routingChangedTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._routingChangedTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_uniqueStorage()._routingChangedTime = newValue}
    }
    /// Returns true if `routingChangedTime` has been explicitly set.
    public var hasRoutingChangedTime: Bool {_storage._routingChangedTime != nil}
    /// Clears the value of `routingChangedTime`. Subsequent reads from it will return its default value.
    public mutating func clearRoutingChangedTime() {_uniqueStorage()._routingChangedTime = nil}

    /// (-- api-linter: core::0140::prepositions=disabled
    ///     aip.dev/not-precedent: 'Since' captures the field semantics despite being a preposition. --)
    /// Unset if not current.
    public var currentSinceTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._currentSinceTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_uniqueStorage()._currentSinceTime = newValue}
    }
    /// Returns true if `currentSinceTime` has been explicitly set.
    public var hasCurrentSinceTime: Bool {_storage._currentSinceTime != nil}
    /// Clears the value of `currentSinceTime`. Subsequent reads from it will return its default value.
    public mutating func clearCurrentSinceTime() {_uniqueStorage()._currentSinceTime = nil}

    /// (-- api-linter: core::0140::prepositions=disabled
    ///     aip.dev/not-precedent: 'Since' captures the field semantics despite being a preposition. --)
    /// Unset if not ramping. Updated when the version first starts ramping, not on each ramp change.
    public var rampingSinceTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._rampingSinceTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_uniqueStorage()._rampingSinceTime = newValue}
    }
    /// Returns true if `rampingSinceTime` has been explicitly set.
    public var hasRampingSinceTime: Bool {_storage._rampingSinceTime != nil}
    /// Clears the value of `rampingSinceTime`. Subsequent reads from it will return its default value.
    public mutating func clearRampingSinceTime() {_uniqueStorage()._rampingSinceTime = nil}

    /// Timestamp when this version first became current or ramping.
    public var firstActivationTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._firstActivationTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_uniqueStorage()._firstActivationTime = newValue}
    }
    /// Returns true if `firstActivationTime` has been explicitly set.
    public var hasFirstActivationTime: Bool {_storage._firstActivationTime != nil}
    /// Clears the value of `firstActivationTime`. Subsequent reads from it will return its default value.
    public mutating func clearFirstActivationTime() {_uniqueStorage()._firstActivationTime = nil}

    /// Timestamp when this version last became current.
    /// Can be used to determine whether a version has ever been Current.
    public var lastCurrentTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._lastCurrentTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_uniqueStorage()._lastCurrentTime = newValue}
    }
    /// Returns true if `lastCurrentTime` has been explicitly set.
    public var hasLastCurrentTime: Bool {_storage._lastCurrentTime != nil}
    /// Clears the value of `lastCurrentTime`. Subsequent reads from it will return its default value.
    public mutating func clearLastCurrentTime() {_uniqueStorage()._lastCurrentTime = nil}

    /// Timestamp when this version last stopped being current or ramping.
    /// Cleared if the version becomes current or ramping again.
    public var lastDeactivationTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._lastDeactivationTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_uniqueStorage()._lastDeactivationTime = newValue}
    }
    /// Returns true if `lastDeactivationTime` has been explicitly set.
    public var hasLastDeactivationTime: Bool {_storage._lastDeactivationTime != nil}
    /// Clears the value of `lastDeactivationTime`. Subsequent reads from it will return its default value.
    public mutating func clearLastDeactivationTime() {_uniqueStorage()._lastDeactivationTime = nil}

    /// Range: [0, 100]. Must be zero if the version is not ramping (i.e. `ramping_since_time` is nil).
    /// Can be in the range [0, 100] if the version is ramping.
    public var rampPercentage: Float {
      get {_storage._rampPercentage}
    ...
    public var taskQueueInfos: [Api.Deployment.V1.WorkerDeploymentVersionInfo.VersionTaskQueueInfo] {
      get {_storage._taskQueueInfos}
    ...
    public var drainageInfo: Api.Deployment.V1.VersionDrainageInfo {
      get {_storage._drainageInfo ?? Api.Deployment.V1.VersionDrainageInfo()}
      set {_uniqueStorage()._drainageInfo = newValue}
    }
    /// Returns true if `drainageInfo` has been explicitly set.
    public var hasDrainageInfo: Bool {_storage._drainageInfo != nil}
    /// Clears the value of `drainageInfo`. Subsequent reads from it will return its default value.
    public mutating func clearDrainageInfo() {_uniqueStorage()._drainageInfo = nil}

    /// Arbitrary user-provided metadata attached to this version.
    public var metadata: Api.Deployment.V1.VersionMetadata {
      get {_storage._metadata ?? Api.Deployment.V1.VersionMetadata()}
    ...
    public struct VersionTaskQueueInfo: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
...
extension Api.Deployment.V1 {
  ...
  /// Experimental. Worker Deployments are experimental and might significantly change in the future.
  public struct VersionDrainageInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var status: Api.Enums.V1.VersionDrainageStatus = .unspecified

    /// Last time the drainage status changed.
    public var lastChangedTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_lastChangedTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_lastChangedTime = newValue}
    }
    /// Returns true if `lastChangedTime` has been explicitly set.
    public var hasLastChangedTime: Bool {self._lastChangedTime != nil}
    /// Clears the value of `lastChangedTime`. Subsequent reads from it will return its default value.
    public mutating func clearLastChangedTime() {self._lastChangedTime = nil}

    /// Last time the system checked for drainage of this version.
    public var lastCheckedTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_lastCheckedTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_lastCheckedTime = newValue}
    }
    /// Returns true if `lastCheckedTime` has been explicitly set.
    public var hasLastCheckedTime: Bool {self._lastCheckedTime != nil}
    /// Clears the value of `lastCheckedTime`. Subsequent reads from it will return its default value.
    public mutating func clearLastCheckedTime() {self._lastCheckedTime = nil}
...
extension Api.Deployment.V1 {
  ...
  /// Experimental. Worker Deployments are experimental and might significantly change in the future.
  public struct WorkerDeploymentInfo: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var versionSummaries: [Api.Deployment.V1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary] {
      get {_storage._versionSummaries}
    ...
    public var lastModifierIdentity: String {
      get {_storage._lastModifierIdentity}
    ...
    public var managerIdentity: String {
      get {_storage._managerIdentity}
      set {_uniqueStorage()._managerIdentity = newValue}
    }

    /// Indicates whether the routing_config has been fully propagated to all
    /// relevant task queues and their partitions.
    public var routingConfigUpdateState: Api.Enums.V1.RoutingConfigUpdateState {
      get {_storage._routingConfigUpdateState}
      set {_uniqueStorage()._routingConfigUpdateState = newValue}
    }

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public struct WorkerDeploymentVersionSummary: @unchecked Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
      ...
      public var drainageStatus: Api.Enums.V1.VersionDrainageStatus {
        get {_storage._drainageStatus}
      ...
      /// Last time `current_since_time`, `ramping_since_time, or `ramp_percentage` of this version changed.
      public var routingUpdateTime: SwiftProtobuf.Google_Protobuf_Timestamp {
        get {_storage._routingUpdateTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
        set {_uniqueStorage()._routingUpdateTime = newValue}
      }
      /// Returns true if `routingUpdateTime` has been explicitly set.
      public var hasRoutingUpdateTime: Bool {_storage._routingUpdateTime != nil}
      /// Clears the value of `routingUpdateTime`. Subsequent reads from it will return its default value.
      public mutating func clearRoutingUpdateTime() {_uniqueStorage()._routingUpdateTime = nil}
...
extension Api.Deployment.V1 {
  ...
  public struct WorkerDeploymentVersion: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Deployment.V1 {
  ...
  public struct VersionMetadata: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Arbitrary key-values.
    public var entries: Dictionary<String,Api.Common.V1.Payload> = [:]
...
extension Api.Deployment.V1 {
  ...
  public struct RoutingConfig: Sendable {
    ...
    public var currentDeploymentVersion: Api.Deployment.V1.WorkerDeploymentVersion {
    ...
    public var hasCurrentDeploymentVersion: Bool {self._currentDeploymentVersion != nil}
    /// Clears the value of `currentDeploymentVersion`. Subsequent reads from it will return its default value.
    public mutating func clearCurrentDeploymentVersion() {self._currentDeploymentVersion = nil}
    ...
    public var rampingDeploymentVersion: Api.Deployment.V1.WorkerDeploymentVersion {
    ...
    public var hasRampingDeploymentVersion: Bool {self._rampingDeploymentVersion != nil}
    /// Clears the value of `rampingDeploymentVersion`. Subsequent reads from it will return its default value.
    public mutating func clearRampingDeploymentVersion() {self._rampingDeploymentVersion = nil}

    /// Deprecated. Use `ramping_deployment_version`.
    ///
    /// NOTE: This field was marked as deprecated in the .proto file.
    public var rampingVersion: String = String()

    /// Percentage of tasks that are routed to the Ramping Version instead of the Current Version.
    /// Valid range: [0, 100]. A 100% value means the Ramping Version is receiving full traffic but
    /// not yet "promoted" to be the Current Version, likely due to pending validations.
    /// A 0% value means the Ramping Version is receiving no traffic.
    public var rampingVersionPercentage: Float = 0

    /// Last time current version was changed.
    public var currentVersionChangedTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_currentVersionChangedTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_currentVersionChangedTime = newValue}
    }
    /// Returns true if `currentVersionChangedTime` has been explicitly set.
    public var hasCurrentVersionChangedTime: Bool {self._currentVersionChangedTime != nil}
    /// Clears the value of `currentVersionChangedTime`. Subsequent reads from it will return its default value.
    public mutating func clearCurrentVersionChangedTime() {self._currentVersionChangedTime = nil}

    /// Last time ramping version was changed. Not updated if only the ramp percentage changes.
    public var rampingVersionChangedTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_rampingVersionChangedTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_rampingVersionChangedTime = newValue}
    }
    /// Returns true if `rampingVersionChangedTime` has been explicitly set.
    public var hasRampingVersionChangedTime: Bool {self._rampingVersionChangedTime != nil}
    /// Clears the value of `rampingVersionChangedTime`. Subsequent reads from it will return its default value.
    public mutating func clearRampingVersionChangedTime() {self._rampingVersionChangedTime = nil}
    ...
    public var rampingVersionPercentageChangedTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_rampingVersionPercentageChangedTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    ...
    public var hasRampingVersionPercentageChangedTime: Bool {self._rampingVersionPercentageChangedTime != nil}
    /// Clears the value of `rampingVersionPercentageChangedTime`. Subsequent reads from it will return its default value.
    public mutating func clearRampingVersionPercentageChangedTime() {self._rampingVersionPercentageChangedTime = nil}
...
extension Api.Deployment.V1 {
  ...
  public struct InheritedAutoUpgradeInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// The source deployment version of the parent/previous workflow.
    public var sourceDeploymentVersion: Api.Deployment.V1.WorkerDeploymentVersion {
      get {_sourceDeploymentVersion ?? Api.Deployment.V1.WorkerDeploymentVersion()}
      set {_sourceDeploymentVersion = newValue}
    }
    /// Returns true if `sourceDeploymentVersion` has been explicitly set.
    public var hasSourceDeploymentVersion: Bool {self._sourceDeploymentVersion != nil}
    /// Clears the value of `sourceDeploymentVersion`. Subsequent reads from it will return its default value.
    public mutating func clearSourceDeploymentVersion() {self._sourceDeploymentVersion = nil}

    /// The revision number of the source deployment version of the parent/previous workflow.
    public var sourceDeploymentRevisionNumber: Int64 = 0

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _sourceDeploymentVersion: Api.Deployment.V1.WorkerDeploymentVersion? = nil
  }
}
...
extension Api.Deployment.V1.WorkerDeploymentOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerDeploymentOptions"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}deployment_name\0\u{3}build_id\0\u{3}worker_versioning_mode\0")
  ...
  public static func ==(lhs: Api.Deployment.V1.WorkerDeploymentOptions, rhs: Api.Deployment.V1.WorkerDeploymentOptions) -> Bool {
...
extension Api.Deployment.V1.Deployment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Deployment"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}series_name\0\u{3}build_id\0")
  ...
  public static func ==(lhs: Api.Deployment.V1.Deployment, rhs: Api.Deployment.V1.Deployment) -> Bool {
...
extension Api.Deployment.V1.DeploymentInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DeploymentInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}deployment\0\u{3}create_time\0\u{3}task_queue_infos\0\u{1}metadata\0\u{3}is_current\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: &self.metadata) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.metadata.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: self.metadata, fieldNumber: 4)
    }
  ...
  public static func ==(lhs: Api.Deployment.V1.DeploymentInfo, rhs: Api.Deployment.V1.DeploymentInfo) -> Bool {
...
extension Api.Deployment.V1.DeploymentInfo.TaskQueueInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Api.Deployment.V1.DeploymentInfo.protoMessageName + ".TaskQueueInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}type\0\u{3}first_poller_time\0")
  ...
  public static func ==(lhs: Api.Deployment.V1.DeploymentInfo.TaskQueueInfo, rhs: Api.Deployment.V1.DeploymentInfo.TaskQueueInfo) -> Bool {
...
extension Api.Deployment.V1.UpdateDeploymentMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UpdateDeploymentMetadata"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}upsert_entries\0\u{3}remove_entries\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: &self.upsertEntries) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.upsertEntries.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: self.upsertEntries, fieldNumber: 1)
    }
  ...
  public static func ==(lhs: Api.Deployment.V1.UpdateDeploymentMetadata, rhs: Api.Deployment.V1.UpdateDeploymentMetadata) -> Bool {
...
extension Api.Deployment.V1.DeploymentListInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DeploymentListInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}deployment\0\u{3}create_time\0\u{3}is_current\0")
  ...
  public static func ==(lhs: Api.Deployment.V1.DeploymentListInfo, rhs: Api.Deployment.V1.DeploymentListInfo) -> Bool {
    if lhs._deployment != rhs._deployment {return false}
    if lhs._createTime != rhs._createTime {return false}
    if lhs.isCurrent != rhs.isCurrent {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.Deployment.V1.WorkerDeploymentVersionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerDeploymentVersionInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}version\0\u{3}deployment_name\0\u{3}create_time\0\u{3}routing_changed_time\0\u{3}current_since_time\0\u{3}ramping_since_time\0\u{3}ramp_percentage\0\u{3}task_queue_infos\0\u{3}drainage_info\0\u{1}metadata\0\u{3}deployment_version\0\u{3}first_activation_time\0\u{3}last_deactivation_time\0\u{1}status\0\u{3}last_current_time\0")

  fileprivate class _StorageClass {
    var _version: String = String()
    var _status: Api.Enums.V1.WorkerDeploymentVersionStatus = .unspecified
    ...
    var _lastCurrentTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _lastDeactivationTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _rampPercentage: Float = 0
    var _taskQueueInfos: [Api.Deployment.V1.WorkerDeploymentVersionInfo.VersionTaskQueueInfo] = []
    var _drainageInfo: Api.Deployment.V1.VersionDrainageInfo? = nil
    var _metadata: Api.Deployment.V1.VersionMetadata? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _lastCurrentTime = source._lastCurrentTime
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 15: try { try decoder.decodeSingularMessageField(value: &_storage._lastCurrentTime) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._lastCurrentTime {
  ...
  public static func ==(lhs: Api.Deployment.V1.WorkerDeploymentVersionInfo, rhs: Api.Deployment.V1.WorkerDeploymentVersionInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._lastCurrentTime != rhs_storage._lastCurrentTime {return false}
...
extension Api.Deployment.V1.WorkerDeploymentVersionInfo.VersionTaskQueueInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Api.Deployment.V1.WorkerDeploymentVersionInfo.protoMessageName + ".VersionTaskQueueInfo"
  ...
  public static func ==(lhs: Api.Deployment.V1.WorkerDeploymentVersionInfo.VersionTaskQueueInfo, rhs: Api.Deployment.V1.WorkerDeploymentVersionInfo.VersionTaskQueueInfo) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.type != rhs.type {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.Deployment.V1.VersionDrainageInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".VersionDrainageInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}status\0\u{3}last_changed_time\0\u{3}last_checked_time\0")
  ...
  public static func ==(lhs: Api.Deployment.V1.VersionDrainageInfo, rhs: Api.Deployment.V1.VersionDrainageInfo) -> Bool {
...
extension Api.Deployment.V1.WorkerDeploymentInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerDeploymentInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{3}version_summaries\0\u{3}create_time\0\u{3}routing_config\0\u{3}last_modifier_identity\0\u{3}manager_identity\0\u{3}routing_config_update_state\0")

  fileprivate class _StorageClass {
    var _name: String = String()
    var _versionSummaries: [Api.Deployment.V1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary] = []
    var _createTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _routingConfig: Api.Deployment.V1.RoutingConfig? = nil
    var _lastModifierIdentity: String = String()
    var _managerIdentity: String = String()
    var _routingConfigUpdateState: Api.Enums.V1.RoutingConfigUpdateState = .unspecified
    ...
    init(copying source: _StorageClass) {
      ...
      _managerIdentity = source._managerIdentity
      _routingConfigUpdateState = source._routingConfigUpdateState
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._managerIdentity) }()
        case 7: try { try decoder.decodeSingularEnumField(value: &_storage._routingConfigUpdateState) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._managerIdentity.isEmpty {
        try visitor.visitSingularStringField(value: _storage._managerIdentity, fieldNumber: 6)
      }
      if _storage._routingConfigUpdateState != .unspecified {
        try visitor.visitSingularEnumField(value: _storage._routingConfigUpdateState, fieldNumber: 7)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Api.Deployment.V1.WorkerDeploymentInfo, rhs: Api.Deployment.V1.WorkerDeploymentInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._managerIdentity != rhs_storage._managerIdentity {return false}
        if _storage._routingConfigUpdateState != rhs_storage._routingConfigUpdateState {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Api.Deployment.V1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Api.Deployment.V1.WorkerDeploymentInfo.protoMessageName + ".WorkerDeploymentVersionSummary"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}version\0\u{3}create_time\0\u{3}drainage_status\0\u{3}deployment_version\0\u{3}drainage_info\0\u{3}current_since_time\0\u{3}ramping_since_time\0\u{3}routing_update_time\0\u{3}first_activation_time\0\u{3}last_deactivation_time\0\u{1}status\0\u{3}last_current_time\0")
  ...
  fileprivate class _StorageClass {
    ...
    var _deploymentVersion: Api.Deployment.V1.WorkerDeploymentVersion? = nil
    var _createTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _drainageStatus: Api.Enums.V1.VersionDrainageStatus = .unspecified
    var _drainageInfo: Api.Deployment.V1.VersionDrainageInfo? = nil
    var _currentSinceTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _rampingSinceTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 12: try { try decoder.decodeSingularMessageField(value: &_storage._lastCurrentTime) }()
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: Api.Deployment.V1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary, rhs: Api.Deployment.V1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.Deployment.V1.WorkerDeploymentVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerDeploymentVersion"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}build_id\0\u{3}deployment_name\0")
  ...
  public static func ==(lhs: Api.Deployment.V1.WorkerDeploymentVersion, rhs: Api.Deployment.V1.WorkerDeploymentVersion) -> Bool {
    if lhs.buildID != rhs.buildID {return false}
    if lhs.deploymentName != rhs.deploymentName {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.Deployment.V1.VersionMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".VersionMetadata"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: &self.entries) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.entries.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Api.Common.V1.Payload>.self, value: self.entries, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Api.Deployment.V1.VersionMetadata, rhs: Api.Deployment.V1.VersionMetadata) -> Bool {
...
extension Api.Deployment.V1.RoutingConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RoutingConfig"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}current_version\0\u{3}ramping_version\0\u{3}ramping_version_percentage\0\u{3}current_version_changed_time\0\u{3}ramping_version_changed_time\0\u{3}ramping_version_percentage_changed_time\0\u{3}current_deployment_version\0\u{4}\u{2}ramping_deployment_version\0\u{3}revision_number\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularInt64Field(value: &self.revisionNumber) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.revisionNumber != 0 {
      try visitor.visitSingularInt64Field(value: self.revisionNumber, fieldNumber: 10)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Api.Deployment.V1.RoutingConfig, rhs: Api.Deployment.V1.RoutingConfig) -> Bool {
...
extension Api.Deployment.V1.InheritedAutoUpgradeInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".InheritedAutoUpgradeInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}source_deployment_version\0\u{3}source_deployment_revision_number\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._sourceDeploymentVersion) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.sourceDeploymentRevisionNumber) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._sourceDeploymentVersion {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    if self.sourceDeploymentRevisionNumber != 0 {
      try visitor.visitSingularInt64Field(value: self.sourceDeploymentRevisionNumber, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Api.Deployment.V1.InheritedAutoUpgradeInfo, rhs: Api.Deployment.V1.InheritedAutoUpgradeInfo) -> Bool {
    if lhs._sourceDeploymentVersion != rhs._sourceDeploymentVersion {return false}
    if lhs.sourceDeploymentRevisionNumber != rhs.sourceDeploymentRevisionNumber {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
