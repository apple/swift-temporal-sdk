...
extension Api.Schedule.V1 {
  ...
  package struct CalendarSpec: Sendable {
...
extension Api.Schedule.V1 {
  ...
  package struct StructuredCalendarSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Match seconds (0-59)
    package var second: [Api.Schedule.V1.Range] = []

    /// Match minutes (0-59)
    package var minute: [Api.Schedule.V1.Range] = []

    /// Match hours (0-23)
    package var hour: [Api.Schedule.V1.Range] = []

    /// Match days of the month (1-31)
    /// (-- api-linter: core::0140::prepositions=disabled
    ///     aip.dev/not-precedent: standard name of field --)
    package var dayOfMonth: [Api.Schedule.V1.Range] = []

    /// Match months (1-12)
    package var month: [Api.Schedule.V1.Range] = []

    /// Match years.
    package var year: [Api.Schedule.V1.Range] = []

    /// Match days of the week (0-6; 0 is Sunday).
    package var dayOfWeek: [Api.Schedule.V1.Range] = []
...
extension Api.Schedule.V1 {
  ...
  package struct IntervalSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var hasInterval: Bool {self._interval != nil}
    ...
    package var hasPhase: Bool {self._phase != nil}
...
extension Api.Schedule.V1 {
  ...
  package struct ScheduleSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Calendar-based specifications of times.
    package var structuredCalendar: [Api.Schedule.V1.StructuredCalendarSpec] = []
    ...
    /// Calendar-based specifications of times.
    package var calendar: [Api.Schedule.V1.CalendarSpec] = []

    /// Interval-based specifications of times.
    package var interval: [Api.Schedule.V1.IntervalSpec] = []

    /// Any timestamps matching any of exclude_* will be skipped.
    /// Deprecated. Use exclude_structured_calendar.
    ///
    /// NOTE: This field was marked as deprecated in the .proto file.
    package var excludeCalendar: [Api.Schedule.V1.CalendarSpec] = []

    package var excludeStructuredCalendar: [Api.Schedule.V1.StructuredCalendarSpec] = []
...
extension Api.Schedule.V1 {
  ...
  package struct SchedulePolicies: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var overlapPolicy: Api.Enums.V1.ScheduleOverlapPolicy = .unspecified
    ...
    package var hasCatchupWindow: Bool {self._catchupWindow != nil}
...
extension Api.Schedule.V1 {
  ...
  package struct ScheduleAction: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    package var action: Api.Schedule.V1.ScheduleAction.OneOf_Action? = nil
    ...
    package var startWorkflow: Api.Workflow.V1.NewWorkflowExecutionInfo {
      get {
...
extension Api.Schedule.V1 {
  ...
  package struct ScheduleActionResult: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var hasScheduleTime: Bool {self._scheduleTime != nil}
    ...
    package var hasActualTime: Bool {self._actualTime != nil}
    ...
    package var startWorkflowResult: Api.Common.V1.WorkflowExecution {
    ...
    package var hasStartWorkflowResult: Bool {self._startWorkflowResult != nil}
    ...
    package var startWorkflowStatus: Api.Enums.V1.WorkflowExecutionStatus = .unspecified
...
extension Api.Schedule.V1 {
  ...
  package struct ScheduleState: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Schedule.V1 {
  ...
  package struct TriggerImmediatelyRequest: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Schedule.V1 {
  ...
  package struct BackfillRequest: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Schedule.V1 {
  ...
  package struct SchedulePatch: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// If set, trigger one action immediately.
    package var triggerImmediately: Api.Schedule.V1.TriggerImmediatelyRequest {
    ...
    package var hasTriggerImmediately: Bool {self._triggerImmediately != nil}
    ...
    package var backfillRequest: [Api.Schedule.V1.BackfillRequest] = []
...
extension Api.Schedule.V1 {
  ...
  package struct ScheduleInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var runningWorkflows: [Api.Common.V1.WorkflowExecution] = []

    /// Most recent ten actual action times (including manual triggers).
    package var recentActions: [Api.Schedule.V1.ScheduleActionResult] = []
...
extension Api.Schedule.V1 {
  ...
  package struct Schedule: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    package var spec: Api.Schedule.V1.ScheduleSpec {
    ...
    package var action: Api.Schedule.V1.ScheduleAction {
      get {_storage._action ?? Api.Schedule.V1.ScheduleAction()}
      set {_uniqueStorage()._action = newValue}
    }
    /// Returns true if `action` has been explicitly set.
    package var hasAction: Bool {_storage._action != nil}
    /// Clears the value of `action`. Subsequent reads from it will return its default value.
    package mutating func clearAction() {_uniqueStorage()._action = nil}

    package var policies: Api.Schedule.V1.SchedulePolicies {
    ...
    package var hasPolicies: Bool {_storage._policies != nil}
    ...
    package var state: Api.Schedule.V1.ScheduleState {
      get {_storage._state ?? Api.Schedule.V1.ScheduleState()}
      set {_uniqueStorage()._state = newValue}
    }
    /// Returns true if `state` has been explicitly set.
    package var hasState: Bool {_storage._state != nil}
...
extension Api.Schedule.V1 {
  ...
  package struct ScheduleListInfo: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Schedule.V1 {
  ...
  package struct ScheduleListEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var info: Api.Schedule.V1.ScheduleListInfo {
...
extension Api.Schedule.V1.CalendarSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.CalendarSpec, rhs: Api.Schedule.V1.CalendarSpec) -> Bool {
...
extension Api.Schedule.V1.Range: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.Range, rhs: Api.Schedule.V1.Range) -> Bool {
...
extension Api.Schedule.V1.StructuredCalendarSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.StructuredCalendarSpec, rhs: Api.Schedule.V1.StructuredCalendarSpec) -> Bool {
    if lhs.second != rhs.second {return false}
    if lhs.minute != rhs.minute {return false}
    if lhs.hour != rhs.hour {return false}
    if lhs.dayOfMonth != rhs.dayOfMonth {return false}
...
extension Api.Schedule.V1.IntervalSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.IntervalSpec, rhs: Api.Schedule.V1.IntervalSpec) -> Bool {
...
extension Api.Schedule.V1.ScheduleSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.ScheduleSpec, rhs: Api.Schedule.V1.ScheduleSpec) -> Bool {
...
extension Api.Schedule.V1.SchedulePolicies: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.SchedulePolicies, rhs: Api.Schedule.V1.SchedulePolicies) -> Bool {
...
extension Api.Schedule.V1.ScheduleAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.ScheduleAction, rhs: Api.Schedule.V1.ScheduleAction) -> Bool {
...
extension Api.Schedule.V1.ScheduleActionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.ScheduleActionResult, rhs: Api.Schedule.V1.ScheduleActionResult) -> Bool {
...
extension Api.Schedule.V1.ScheduleState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.ScheduleState, rhs: Api.Schedule.V1.ScheduleState) -> Bool {
...
extension Api.Schedule.V1.TriggerImmediatelyRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.TriggerImmediatelyRequest, rhs: Api.Schedule.V1.TriggerImmediatelyRequest) -> Bool {
    if lhs.overlapPolicy != rhs.overlapPolicy {return false}
...
extension Api.Schedule.V1.BackfillRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.BackfillRequest, rhs: Api.Schedule.V1.BackfillRequest) -> Bool {
    if lhs._startTime != rhs._startTime {return false}
    if lhs._endTime != rhs._endTime {return false}
    if lhs.overlapPolicy != rhs.overlapPolicy {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.Schedule.V1.SchedulePatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.SchedulePatch, rhs: Api.Schedule.V1.SchedulePatch) -> Bool {
...
extension Api.Schedule.V1.ScheduleInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.ScheduleInfo, rhs: Api.Schedule.V1.ScheduleInfo) -> Bool {
...
extension Api.Schedule.V1.Schedule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.Schedule, rhs: Api.Schedule.V1.Schedule) -> Bool {
...
extension Api.Schedule.V1.ScheduleListInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.ScheduleListInfo, rhs: Api.Schedule.V1.ScheduleListInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.Schedule.V1.ScheduleListEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.Schedule.V1.ScheduleListEntry, rhs: Api.Schedule.V1.ScheduleListEntry) -> Bool {
