...
extension Api.Schedule.V1 {
  ...
  public struct CalendarSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Expression to match seconds. Default: 0
    public var second: String = String()

    /// Expression to match minutes. Default: 0
    public var minute: String = String()
    ...
    public var dayOfMonth: String = String()
    ...
    public var dayOfWeek: String = String()
...
extension Api.Schedule.V1 {
  ...
  public struct StructuredCalendarSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Match seconds (0-59)
    public var second: [Api.Schedule.V1.Range] = []

    /// Match minutes (0-59)
    public var minute: [Api.Schedule.V1.Range] = []

    /// Match hours (0-23)
    public var hour: [Api.Schedule.V1.Range] = []

    /// Match days of the month (1-31)
    /// (-- api-linter: core::0140::prepositions=disabled
    ///     aip.dev/not-precedent: standard name of field --)
    public var dayOfMonth: [Api.Schedule.V1.Range] = []

    /// Match months (1-12)
    public var month: [Api.Schedule.V1.Range] = []

    /// Match years.
    public var year: [Api.Schedule.V1.Range] = []

    /// Match days of the week (0-6; 0 is Sunday).
    public var dayOfWeek: [Api.Schedule.V1.Range] = []
...
extension Api.Schedule.V1 {
  ...
  public struct IntervalSpec: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var phase: SwiftProtobuf.Google_Protobuf_Duration {
      get {_phase ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_phase = newValue}
    }
...
extension Api.Schedule.V1 {
  ...
  public struct ScheduleSpec: Sendable {
    ...
    public var structuredCalendar: [Api.Schedule.V1.StructuredCalendarSpec] = []
    ...
    /// Calendar-based specifications of times.
    public var calendar: [Api.Schedule.V1.CalendarSpec] = []

    /// Interval-based specifications of times.
    public var interval: [Api.Schedule.V1.IntervalSpec] = []

    /// Any timestamps matching any of exclude_* will be skipped.
    /// Deprecated. Use exclude_structured_calendar.
    ///
    /// NOTE: This field was marked as deprecated in the .proto file.
    public var excludeCalendar: [Api.Schedule.V1.CalendarSpec] = []

    public var excludeStructuredCalendar: [Api.Schedule.V1.StructuredCalendarSpec] = []
    ...
    public var timezoneName: String = String()

    public var timezoneData: Data = Data()
...
extension Api.Schedule.V1 {
  ...
  public struct SchedulePolicies: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var overlapPolicy: Api.Enums.V1.ScheduleOverlapPolicy = .unspecified
    ...
    public var catchupWindow: SwiftProtobuf.Google_Protobuf_Duration {
      get {_catchupWindow ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_catchupWindow = newValue}
    }
    /// Returns true if `catchupWindow` has been explicitly set.
    public var hasCatchupWindow: Bool {self._catchupWindow != nil}
    /// Clears the value of `catchupWindow`. Subsequent reads from it will return its default value.
    public mutating func clearCatchupWindow() {self._catchupWindow = nil}

    /// If true, and a workflow run fails or times out, turn on "paused".
    /// This applies after retry policies: the full chain of retries must fail to
    /// trigger a pause here.
    public var pauseOnFailure: Bool = false

    /// If true, and the action would start a workflow, a timestamp will not be
    /// appended to the scheduled workflow id.
    public var keepOriginalWorkflowID: Bool = false
...
extension Api.Schedule.V1 {
  ...
  public struct ScheduleAction: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var action: Api.Schedule.V1.ScheduleAction.OneOf_Action? = nil
    ...
    public var startWorkflow: Api.Workflow.V1.NewWorkflowExecutionInfo {
      get {
        if case .startWorkflow(let v)? = action {return v}
        return Api.Workflow.V1.NewWorkflowExecutionInfo()
      }
    ...
    public enum OneOf_Action: Equatable, Sendable {
      ...
      /// The workflow id of the started workflow may not match this exactly,
      /// it may have a timestamp appended for uniqueness.
      case startWorkflow(Api.Workflow.V1.NewWorkflowExecutionInfo)
...
extension Api.Schedule.V1 {
  ...
  public struct ScheduleActionResult: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var actualTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_actualTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    ...
    public var startWorkflowResult: Api.Common.V1.WorkflowExecution {
      get {_startWorkflowResult ?? Api.Common.V1.WorkflowExecution()}
      set {_startWorkflowResult = newValue}
    }
    /// Returns true if `startWorkflowResult` has been explicitly set.
    public var hasStartWorkflowResult: Bool {self._startWorkflowResult != nil}
    /// Clears the value of `startWorkflowResult`. Subsequent reads from it will return its default value.
    public mutating func clearStartWorkflowResult() {self._startWorkflowResult = nil}

    /// If the action was start_workflow, this field will reflect an
    /// eventually-consistent view of the started workflow's status.
    public var startWorkflowStatus: Api.Enums.V1.WorkflowExecutionStatus = .unspecified
    ...
    fileprivate var _startWorkflowResult: Api.Common.V1.WorkflowExecution? = nil
  }
}
extension Api.Schedule.V1 {


  public struct ScheduleState: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var limitedActions: Bool = false

    public var remainingActions: Int64 = 0
...
extension Api.Schedule.V1 {
  ...
  public struct TriggerImmediatelyRequest: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Schedule.V1 {
  ...
  public struct BackfillRequest: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Schedule.V1 {
  ...
  public struct SchedulePatch: Sendable {
    ...
    public var triggerImmediately: Api.Schedule.V1.TriggerImmediatelyRequest {
      get {_triggerImmediately ?? Api.Schedule.V1.TriggerImmediatelyRequest()}
      set {_triggerImmediately = newValue}
    }
    /// Returns true if `triggerImmediately` has been explicitly set.
    public var hasTriggerImmediately: Bool {self._triggerImmediately != nil}
    /// Clears the value of `triggerImmediately`. Subsequent reads from it will return its default value.
    public mutating func clearTriggerImmediately() {self._triggerImmediately = nil}

    /// If set, runs though the specified time period(s) and takes actions as if that time
    /// passed by right now, all at once. The overlap policy can be overridden for the
    /// scope of the backfill.
    public var backfillRequest: [Api.Schedule.V1.BackfillRequest] = []

    /// If set, change the state to paused or unpaused (respectively) and set the
    /// notes field to the value of the string.
    public var pause: String = String()

    public var unpause: String = String()

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _triggerImmediately: Api.Schedule.V1.TriggerImmediatelyRequest? = nil
  }
}
extension Api.Schedule.V1 {
  ...
  public struct ScheduleInfo: Sendable {
    ...
    public var missedCatchupWindow: Int64 = 0

    /// Number of skipped actions due to overlap.
    public var overlapSkipped: Int64 = 0

    /// Number of dropped actions due to buffer limit.
    public var bufferDropped: Int64 = 0
    ...
    public var runningWorkflows: [Api.Common.V1.WorkflowExecution] = []

    /// Most recent ten actual action times (including manual triggers).
    public var recentActions: [Api.Schedule.V1.ScheduleActionResult] = []

    /// Next ten scheduled action times.
    public var futureActionTimes: [SwiftProtobuf.Google_Protobuf_Timestamp] = []
    ...
    ///
    /// NOTE: This field was marked as deprecated in the .proto file.
    public var invalidScheduleError: String = String()
...
extension Api.Schedule.V1 {
  ...
  public struct Schedule: @unchecked Sendable {
    ...
    public var spec: Api.Schedule.V1.ScheduleSpec {
      get {_storage._spec ?? Api.Schedule.V1.ScheduleSpec()}
    ...
    public var action: Api.Schedule.V1.ScheduleAction {
      get {_storage._action ?? Api.Schedule.V1.ScheduleAction()}
    ...
    public var policies: Api.Schedule.V1.SchedulePolicies {
      get {_storage._policies ?? Api.Schedule.V1.SchedulePolicies()}
      set {_uniqueStorage()._policies = newValue}
    }
    /// Returns true if `policies` has been explicitly set.
    public var hasPolicies: Bool {_storage._policies != nil}
    ...
    public var state: Api.Schedule.V1.ScheduleState {
      get {_storage._state ?? Api.Schedule.V1.ScheduleState()}
...
extension Api.Schedule.V1 {
  ...
  public struct ScheduleListInfo: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var recentActions: [Api.Schedule.V1.ScheduleActionResult] {
      get {_storage._recentActions}
      set {_uniqueStorage()._recentActions = newValue}
    }

    public var futureActionTimes: [SwiftProtobuf.Google_Protobuf_Timestamp] {
      get {_storage._futureActionTimes}
...
extension Api.Schedule.V1 {
  ...
  public struct ScheduleListEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var info: Api.Schedule.V1.ScheduleListInfo {
      get {_info ?? Api.Schedule.V1.ScheduleListInfo()}
      set {_info = newValue}
    }
    ...
    fileprivate var _info: Api.Schedule.V1.ScheduleListInfo? = nil
  }
}
...
extension Api.Schedule.V1.CalendarSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CalendarSpec"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}second\0\u{1}minute\0\u{1}hour\0\u{3}day_of_month\0\u{1}month\0\u{1}year\0\u{3}day_of_week\0\u{1}comment\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.CalendarSpec, rhs: Api.Schedule.V1.CalendarSpec) -> Bool {
...
extension Api.Schedule.V1.Range: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Range"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}start\0\u{1}end\0\u{1}step\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.Range, rhs: Api.Schedule.V1.Range) -> Bool {
...
extension Api.Schedule.V1.StructuredCalendarSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StructuredCalendarSpec"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}second\0\u{1}minute\0\u{1}hour\0\u{3}day_of_month\0\u{1}month\0\u{1}year\0\u{3}day_of_week\0\u{1}comment\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.StructuredCalendarSpec, rhs: Api.Schedule.V1.StructuredCalendarSpec) -> Bool {
    if lhs.second != rhs.second {return false}
    if lhs.minute != rhs.minute {return false}
    if lhs.hour != rhs.hour {return false}
    if lhs.dayOfMonth != rhs.dayOfMonth {return false}
...
extension Api.Schedule.V1.IntervalSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".IntervalSpec"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}interval\0\u{1}phase\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.IntervalSpec, rhs: Api.Schedule.V1.IntervalSpec) -> Bool {
...
extension Api.Schedule.V1.ScheduleSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScheduleSpec"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}calendar\0\u{1}interval\0\u{3}exclude_calendar\0\u{3}start_time\0\u{3}end_time\0\u{1}jitter\0\u{3}structured_calendar\0\u{3}cron_string\0\u{3}exclude_structured_calendar\0\u{3}timezone_name\0\u{3}timezone_data\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.ScheduleSpec, rhs: Api.Schedule.V1.ScheduleSpec) -> Bool {
...
extension Api.Schedule.V1.SchedulePolicies: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SchedulePolicies"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}overlap_policy\0\u{3}catchup_window\0\u{3}pause_on_failure\0\u{3}keep_original_workflow_id\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.SchedulePolicies, rhs: Api.Schedule.V1.SchedulePolicies) -> Bool {
...
extension Api.Schedule.V1.ScheduleAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScheduleAction"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_workflow\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Api.Workflow.V1.NewWorkflowExecutionInfo?
  ...
  public static func ==(lhs: Api.Schedule.V1.ScheduleAction, rhs: Api.Schedule.V1.ScheduleAction) -> Bool {
...
extension Api.Schedule.V1.ScheduleActionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScheduleActionResult"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}schedule_time\0\u{3}actual_time\0\u{4}\u{9}start_workflow_result\0\u{3}start_workflow_status\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.ScheduleActionResult, rhs: Api.Schedule.V1.ScheduleActionResult) -> Bool {
...
extension Api.Schedule.V1.ScheduleState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScheduleState"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}notes\0\u{1}paused\0\u{3}limited_actions\0\u{3}remaining_actions\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.ScheduleState, rhs: Api.Schedule.V1.ScheduleState) -> Bool {
...
extension Api.Schedule.V1.TriggerImmediatelyRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TriggerImmediatelyRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}overlap_policy\0\u{3}scheduled_time\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.TriggerImmediatelyRequest, rhs: Api.Schedule.V1.TriggerImmediatelyRequest) -> Bool {
    if lhs.overlapPolicy != rhs.overlapPolicy {return false}
...
extension Api.Schedule.V1.BackfillRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".BackfillRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_time\0\u{3}end_time\0\u{3}overlap_policy\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.BackfillRequest, rhs: Api.Schedule.V1.BackfillRequest) -> Bool {
    if lhs._startTime != rhs._startTime {return false}
    if lhs._endTime != rhs._endTime {return false}
    if lhs.overlapPolicy != rhs.overlapPolicy {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.Schedule.V1.SchedulePatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SchedulePatch"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}trigger_immediately\0\u{3}backfill_request\0\u{1}pause\0\u{1}unpause\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.SchedulePatch, rhs: Api.Schedule.V1.SchedulePatch) -> Bool {
...
extension Api.Schedule.V1.ScheduleInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Api.Schedule.V1.ScheduleInfo, rhs: Api.Schedule.V1.ScheduleInfo) -> Bool {
...
extension Api.Schedule.V1.Schedule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Schedule"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}spec\0\u{1}action\0\u{1}policies\0\u{1}state\0")

  fileprivate class _StorageClass {
    var _spec: Api.Schedule.V1.ScheduleSpec? = nil
    var _action: Api.Schedule.V1.ScheduleAction? = nil
    var _policies: Api.Schedule.V1.SchedulePolicies? = nil
    var _state: Api.Schedule.V1.ScheduleState? = nil
  ...
  public static func ==(lhs: Api.Schedule.V1.Schedule, rhs: Api.Schedule.V1.Schedule) -> Bool {
...
extension Api.Schedule.V1.ScheduleListInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScheduleListInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}spec\0\u{3}workflow_type\0\u{1}notes\0\u{1}paused\0\u{3}recent_actions\0\u{3}future_action_times\0")
  ...
  fileprivate class _StorageClass {
    ...
    var _recentActions: [Api.Schedule.V1.ScheduleActionResult] = []
  ...
  public static func ==(lhs: Api.Schedule.V1.ScheduleListInfo, rhs: Api.Schedule.V1.ScheduleListInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.Schedule.V1.ScheduleListEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScheduleListEntry"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}schedule_id\0\u{1}memo\0\u{3}search_attributes\0\u{1}info\0")
  ...
  public static func ==(lhs: Api.Schedule.V1.ScheduleListEntry, rhs: Api.Schedule.V1.ScheduleListEntry) -> Bool {
