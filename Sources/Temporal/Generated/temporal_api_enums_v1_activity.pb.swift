...
extension Api.Enums.V1 {
  ...
  public enum ActivityExecutionStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Api.Enums.V1.ActivityExecutionStatus] = [
      .unspecified,
      .running,
      .completed,
      .failed,
...
extension Api.Enums.V1 {
  ...
  public enum ActivityIdReusePolicy: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ActivityIdReusePolicy] = [
      .unspecified,
      .allowDuplicate,
...
extension Api.Enums.V1 {
  ...
  public enum ActivityIdConflictPolicy: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ActivityIdConflictPolicy] = [
      .unspecified,
      .fail,
      .useExisting,
    ]
...
extension Api.Enums.V1.ActivityIdReusePolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ACTIVITY_ID_REUSE_POLICY_UNSPECIFIED\0\u{1}ACTIVITY_ID_REUSE_POLICY_ALLOW_DUPLICATE\0\u{1}ACTIVITY_ID_REUSE_POLICY_ALLOW_DUPLICATE_FAILED_ONLY\0\u{1}ACTIVITY_ID_REUSE_POLICY_REJECT_DUPLICATE\0")
}

extension Api.Enums.V1.ActivityIdConflictPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ACTIVITY_ID_CONFLICT_POLICY_UNSPECIFIED\0\u{1}ACTIVITY_ID_CONFLICT_POLICY_FAIL\0\u{1}ACTIVITY_ID_CONFLICT_POLICY_USE_EXISTING\0")
}
