...
extension Api.Enums.V1 {
  ...
  public enum TaskQueueKind: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Api.Enums.V1.TaskQueueKind] = [
      .unspecified,
      .normal,
      .sticky,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum TaskQueueType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.TaskQueueType] = [
      .unspecified,
      .workflow,
      .activity,
      .nexus,
...
extension Api.Enums.V1 {
  ...
  public enum TaskReachability: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.TaskReachability] = [
      .unspecified,
      .newWorkflows,
      .existingWorkflows,
      .openWorkflows,
...
extension Api.Enums.V1 {
  ...
  public enum BuildIdTaskReachability: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.BuildIdTaskReachability] = [
      .unspecified,
      .reachable,
      .closedWorkflowsOnly,
      .unreachable,
...
extension Api.Enums.V1 {
  ...
  public enum DescribeTaskQueueMode: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.DescribeTaskQueueMode] = [
      .unspecified,
      .enhanced,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum RateLimitSource: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.RateLimitSource] = [
      .unspecified,
      .api,
      .worker,
      .system,
...
extension Api.Enums.V1 {
  ...
  public enum RoutingConfigUpdateState: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.RoutingConfigUpdateState] = [
      .unspecified,
      .inProgress,
      .completed,
    ]
...
extension Api.Enums.V1.TaskQueueKind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TASK_QUEUE_KIND_UNSPECIFIED\0\u{1}TASK_QUEUE_KIND_NORMAL\0\u{1}TASK_QUEUE_KIND_STICKY\0")
}

extension Api.Enums.V1.TaskQueueType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TASK_QUEUE_TYPE_UNSPECIFIED\0\u{1}TASK_QUEUE_TYPE_WORKFLOW\0\u{1}TASK_QUEUE_TYPE_ACTIVITY\0\u{1}TASK_QUEUE_TYPE_NEXUS\0")
}

extension Api.Enums.V1.TaskReachability: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TASK_REACHABILITY_UNSPECIFIED\0\u{1}TASK_REACHABILITY_NEW_WORKFLOWS\0\u{1}TASK_REACHABILITY_EXISTING_WORKFLOWS\0\u{1}TASK_REACHABILITY_OPEN_WORKFLOWS\0\u{1}TASK_REACHABILITY_CLOSED_WORKFLOWS\0")
}

extension Api.Enums.V1.BuildIdTaskReachability: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0BUILD_ID_TASK_REACHABILITY_UNSPECIFIED\0\u{1}BUILD_ID_TASK_REACHABILITY_REACHABLE\0\u{1}BUILD_ID_TASK_REACHABILITY_CLOSED_WORKFLOWS_ONLY\0\u{1}BUILD_ID_TASK_REACHABILITY_UNREACHABLE\0")
}

extension Api.Enums.V1.DescribeTaskQueueMode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DESCRIBE_TASK_QUEUE_MODE_UNSPECIFIED\0\u{1}DESCRIBE_TASK_QUEUE_MODE_ENHANCED\0")
}

extension Api.Enums.V1.RateLimitSource: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0RATE_LIMIT_SOURCE_UNSPECIFIED\0\u{1}RATE_LIMIT_SOURCE_API\0\u{1}RATE_LIMIT_SOURCE_WORKER\0\u{1}RATE_LIMIT_SOURCE_SYSTEM\0")
}

extension Api.Enums.V1.RoutingConfigUpdateState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ROUTING_CONFIG_UPDATE_STATE_UNSPECIFIED\0\u{1}ROUTING_CONFIG_UPDATE_STATE_IN_PROGRESS\0\u{1}ROUTING_CONFIG_UPDATE_STATE_COMPLETED\0")
}
