...
extension Api.Sdk.V1 {
  ...
  public struct WorkflowMetadata: Sendable {
    ...
    public var definition: Api.Sdk.V1.WorkflowDefinition {
    ...
    public var currentDetails: String = String()
...
extension Api.Sdk.V1 {
  ...
  public struct WorkflowDefinition: Sendable {
    ...
    public var queryDefinitions: [Api.Sdk.V1.WorkflowInteractionDefinition] = []

    /// Signal definitions, sorted by name.
    public var signalDefinitions: [Api.Sdk.V1.WorkflowInteractionDefinition] = []

    /// Update definitions, sorted by name.
    public var updateDefinitions: [Api.Sdk.V1.WorkflowInteractionDefinition] = []
...
extension Api.Sdk.V1 {
  ...
  /// (-- api-linter: core::0203::optional=disabled --)
  public struct WorkflowInteractionDefinition: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Sdk.V1.WorkflowMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}definition\0\u{3}current_details\0")
  ...
  public static func ==(lhs: Api.Sdk.V1.WorkflowMetadata, rhs: Api.Sdk.V1.WorkflowMetadata) -> Bool {
...
extension Api.Sdk.V1.WorkflowDefinition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{3}query_definitions\0\u{3}signal_definitions\0\u{3}update_definitions\0")
  ...
  public static func ==(lhs: Api.Sdk.V1.WorkflowDefinition, rhs: Api.Sdk.V1.WorkflowDefinition) -> Bool {
...
extension Api.Sdk.V1.WorkflowInteractionDefinition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowInteractionDefinition"
  ...
  public static func ==(lhs: Api.Sdk.V1.WorkflowInteractionDefinition, rhs: Api.Sdk.V1.WorkflowInteractionDefinition) -> Bool {
