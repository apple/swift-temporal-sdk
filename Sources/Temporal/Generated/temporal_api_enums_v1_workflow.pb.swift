...
extension Api.Enums.V1 {
  ...
  public enum WorkflowIdReusePolicy: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Api.Enums.V1.WorkflowIdReusePolicy] = [
      .unspecified,
      .allowDuplicate,
...
extension Api.Enums.V1 {
  ...
  public enum WorkflowIdConflictPolicy: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.WorkflowIdConflictPolicy] = [
      .unspecified,
      .fail,
      .useExisting,
      .terminateExisting,
...
extension Api.Enums.V1 {
  ...
  public enum ParentClosePolicy: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ParentClosePolicy] = [
      .unspecified,
      .terminate,
      .abandon,
      .requestCancel,
...
extension Api.Enums.V1 {
  ...
  public enum ContinueAsNewInitiator: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ContinueAsNewInitiator] = [
      .unspecified,
      .workflow,
      .retry,
      .cronSchedule,
...
extension Api.Enums.V1 {
  ...
  public enum WorkflowExecutionStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.WorkflowExecutionStatus] = [
      .unspecified,
      .running,
      .completed,
      .failed,
...
extension Api.Enums.V1 {
  ...
  public enum PendingActivityState: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.PendingActivityState] = [
      .unspecified,
      .scheduled,
      .started,
      .cancelRequested,
...
extension Api.Enums.V1 {
  ...
  public enum PendingWorkflowTaskState: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.PendingWorkflowTaskState] = [
      .unspecified,
      .scheduled,
      .started,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum HistoryEventFilterType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.HistoryEventFilterType] = [
      .unspecified,
      .allEvent,
      .closeEvent,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum RetryState: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.RetryState] = [
      .unspecified,
      .inProgress,
      .nonRetryableFailure,
      .timeout,
...
extension Api.Enums.V1 {
  ...
  public enum TimeoutType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.TimeoutType] = [
      .unspecified,
      .startToClose,
      .scheduleToStart,
      .scheduleToClose,
...
extension Api.Enums.V1 {
  ...
  public enum VersioningBehavior: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.VersioningBehavior] = [
      .unspecified,
      .pinned,
      .autoUpgrade,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum ContinueAsNewVersioningBehavior: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ContinueAsNewVersioningBehavior] = [
      .unspecified,
      .autoUpgrade,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum SuggestContinueAsNewReason: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.SuggestContinueAsNewReason] = [
      .unspecified,
      .historySizeTooLarge,
...
extension Api.Enums.V1.WorkflowIdConflictPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0WORKFLOW_ID_CONFLICT_POLICY_UNSPECIFIED\0\u{1}WORKFLOW_ID_CONFLICT_POLICY_FAIL\0\u{1}WORKFLOW_ID_CONFLICT_POLICY_USE_EXISTING\0\u{1}WORKFLOW_ID_CONFLICT_POLICY_TERMINATE_EXISTING\0")
}

extension Api.Enums.V1.ParentClosePolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PARENT_CLOSE_POLICY_UNSPECIFIED\0\u{1}PARENT_CLOSE_POLICY_TERMINATE\0\u{1}PARENT_CLOSE_POLICY_ABANDON\0\u{1}PARENT_CLOSE_POLICY_REQUEST_CANCEL\0")
}

extension Api.Enums.V1.ContinueAsNewInitiator: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CONTINUE_AS_NEW_INITIATOR_UNSPECIFIED\0\u{1}CONTINUE_AS_NEW_INITIATOR_WORKFLOW\0\u{1}CONTINUE_AS_NEW_INITIATOR_RETRY\0\u{1}CONTINUE_AS_NEW_INITIATOR_CRON_SCHEDULE\0")
}
...
extension Api.Enums.V1.PendingWorkflowTaskState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PENDING_WORKFLOW_TASK_STATE_UNSPECIFIED\0\u{1}PENDING_WORKFLOW_TASK_STATE_SCHEDULED\0\u{1}PENDING_WORKFLOW_TASK_STATE_STARTED\0")
}

extension Api.Enums.V1.HistoryEventFilterType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0HISTORY_EVENT_FILTER_TYPE_UNSPECIFIED\0\u{1}HISTORY_EVENT_FILTER_TYPE_ALL_EVENT\0\u{1}HISTORY_EVENT_FILTER_TYPE_CLOSE_EVENT\0")
}
...
extension Api.Enums.V1.TimeoutType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TIMEOUT_TYPE_UNSPECIFIED\0\u{1}TIMEOUT_TYPE_START_TO_CLOSE\0\u{1}TIMEOUT_TYPE_SCHEDULE_TO_START\0\u{1}TIMEOUT_TYPE_SCHEDULE_TO_CLOSE\0\u{1}TIMEOUT_TYPE_HEARTBEAT\0")
}

extension Api.Enums.V1.VersioningBehavior: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0VERSIONING_BEHAVIOR_UNSPECIFIED\0\u{1}VERSIONING_BEHAVIOR_PINNED\0\u{1}VERSIONING_BEHAVIOR_AUTO_UPGRADE\0")
}

extension Api.Enums.V1.ContinueAsNewVersioningBehavior: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_UNSPECIFIED\0\u{1}CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_AUTO_UPGRADE\0")
}
