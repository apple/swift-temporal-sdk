...
extension Api.Query.V1 {
  ...
  public struct WorkflowQueryResult: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Did the query succeed or fail?
    public var resultType: Api.Enums.V1.QueryResultType = .unspecified

    /// Set when the query succeeds with the results.
    /// Mutually exclusive with `error_message` and `failure`.
    public var answer: Api.Common.V1.Payloads {
...
extension Api.Query.V1 {
  ...
  public struct QueryRejected: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Query.V1.WorkflowQuery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowQuery"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}query_type\0\u{3}query_args\0\u{1}header\0")
  ...
  public static func ==(lhs: Api.Query.V1.WorkflowQuery, rhs: Api.Query.V1.WorkflowQuery) -> Bool {
...
extension Api.Query.V1.WorkflowQueryResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowQueryResult"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}result_type\0\u{1}answer\0\u{3}error_message\0\u{1}failure\0")
  ...
  public static func ==(lhs: Api.Query.V1.WorkflowQueryResult, rhs: Api.Query.V1.WorkflowQueryResult) -> Bool {
...
extension Api.Query.V1.QueryRejected: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryRejected"
  ...
  public static func ==(lhs: Api.Query.V1.QueryRejected, rhs: Api.Query.V1.QueryRejected) -> Bool {
