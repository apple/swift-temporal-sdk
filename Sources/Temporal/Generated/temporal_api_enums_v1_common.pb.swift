...
extension Api.Enums.V1 {
  ...
  public enum EncodingType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Api.Enums.V1.EncodingType] = [
      .unspecified,
      .proto3,
      .json,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum IndexedValueType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.IndexedValueType] = [
      .unspecified,
      .text,
      .keyword,
      .int,
...
extension Api.Enums.V1 {
  ...
  public enum Severity: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.Severity] = [
      .unspecified,
      .high,
      .medium,
      .low,
...
extension Api.Enums.V1 {
  ...
  public enum CallbackState: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.CallbackState] = [
      .unspecified,
      .standby,
      .scheduled,
      .backingOff,
...
extension Api.Enums.V1 {
  ...
  public enum PendingNexusOperationState: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.PendingNexusOperationState] = [
      .unspecified,
      .scheduled,
      .backingOff,
      .started,
...
extension Api.Enums.V1 {
  ...
  public enum NexusOperationCancellationState: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.NexusOperationCancellationState] = [
      .unspecified,
      .scheduled,
      .backingOff,
      .succeeded,
...
extension Api.Enums.V1 {
  ...
  public enum WorkflowRuleActionScope: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.WorkflowRuleActionScope] = [
      .unspecified,
      .workflow,
      .activity,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum ApplicationErrorCategory: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ApplicationErrorCategory] = [
      .unspecified,
      .benign,
    ]
...
extension Api.Enums.V1 {
  ...
  public enum WorkerStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.WorkerStatus] = [
      .unspecified,
      .running,
      .shuttingDown,
      .shutdown,
...
extension Api.Enums.V1.EncodingType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ENCODING_TYPE_UNSPECIFIED\0\u{1}ENCODING_TYPE_PROTO3\0\u{1}ENCODING_TYPE_JSON\0")
}
...
extension Api.Enums.V1.Severity: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SEVERITY_UNSPECIFIED\0\u{1}SEVERITY_HIGH\0\u{1}SEVERITY_MEDIUM\0\u{1}SEVERITY_LOW\0")
}

extension Api.Enums.V1.CallbackState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CALLBACK_STATE_UNSPECIFIED\0\u{1}CALLBACK_STATE_STANDBY\0\u{1}CALLBACK_STATE_SCHEDULED\0\u{1}CALLBACK_STATE_BACKING_OFF\0\u{1}CALLBACK_STATE_FAILED\0\u{1}CALLBACK_STATE_SUCCEEDED\0\u{1}CALLBACK_STATE_BLOCKED\0")
}

extension Api.Enums.V1.PendingNexusOperationState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PENDING_NEXUS_OPERATION_STATE_UNSPECIFIED\0\u{1}PENDING_NEXUS_OPERATION_STATE_SCHEDULED\0\u{1}PENDING_NEXUS_OPERATION_STATE_BACKING_OFF\0\u{1}PENDING_NEXUS_OPERATION_STATE_STARTED\0\u{1}PENDING_NEXUS_OPERATION_STATE_BLOCKED\0")
}
...
extension Api.Enums.V1.WorkflowRuleActionScope: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0WORKFLOW_RULE_ACTION_SCOPE_UNSPECIFIED\0\u{1}WORKFLOW_RULE_ACTION_SCOPE_WORKFLOW\0\u{1}WORKFLOW_RULE_ACTION_SCOPE_ACTIVITY\0")
}

extension Api.Enums.V1.ApplicationErrorCategory: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APPLICATION_ERROR_CATEGORY_UNSPECIFIED\0\u{1}APPLICATION_ERROR_CATEGORY_BENIGN\0")
}

extension Api.Enums.V1.WorkerStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0WORKER_STATUS_UNSPECIFIED\0\u{1}WORKER_STATUS_RUNNING\0\u{1}WORKER_STATUS_SHUTTING_DOWN\0\u{1}WORKER_STATUS_SHUTDOWN\0")
}
