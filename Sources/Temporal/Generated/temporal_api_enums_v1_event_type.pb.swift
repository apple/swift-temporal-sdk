...
extension Api.Enums.V1 {
  ...
  package enum EventType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    package init?(rawValue: Int) {
      ...
      case 58: self = .workflowExecutionPaused
      case 59: self = .workflowExecutionUnpaused
    ...
    package var rawValue: Int {
      ...
      case .workflowExecutionPaused: return 58
      case .workflowExecutionUnpaused: return 59
      case .UNRECOGNIZED(let i): return i
      }
    }

    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Api.Enums.V1.EventType] = [
      .unspecified,
