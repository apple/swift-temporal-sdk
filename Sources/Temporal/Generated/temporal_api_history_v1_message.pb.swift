...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionStartedEventAttributes: @unchecked Sendable {
    ...
    public var parentWorkflowExecution: Api.Common.V1.WorkflowExecution {
      get {_storage._parentWorkflowExecution ?? Api.Common.V1.WorkflowExecution()}
      set {_uniqueStorage()._parentWorkflowExecution = newValue}
    }
    /// Returns true if `parentWorkflowExecution` has been explicitly set.
    public var hasParentWorkflowExecution: Bool {_storage._parentWorkflowExecution != nil}
    /// Clears the value of `parentWorkflowExecution`. Subsequent reads from it will return its default value.
    public mutating func clearParentWorkflowExecution() {_uniqueStorage()._parentWorkflowExecution = nil}

    /// EventID of the child execution initiated event in parent workflow
    public var parentInitiatedEventID: Int64 {
      get {_storage._parentInitiatedEventID}
    ...
    public var continuedExecutionRunID: String {
      get {_storage._continuedExecutionRunID}
      set {_uniqueStorage()._continuedExecutionRunID = newValue}
    }

    public var initiator: Api.Enums.V1.ContinueAsNewInitiator {
    ...
    public var originalExecutionRunID: String {
      get {_storage._originalExecutionRunID}
    ...
    public var firstExecutionRunID: String {
      get {_storage._firstExecutionRunID}
    ...
    public var workflowExecutionExpirationTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._workflowExecutionExpirationTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    ...
    public var hasWorkflowExecutionExpirationTime: Bool {_storage._workflowExecutionExpirationTime != nil}
    /// Clears the value of `workflowExecutionExpirationTime`. Subsequent reads from it will return its default value.
    public mutating func clearWorkflowExecutionExpirationTime() {_uniqueStorage()._workflowExecutionExpirationTime = nil}
    ...
    public var firstWorkflowTaskBackoff: SwiftProtobuf.Google_Protobuf_Duration {
      get {_storage._firstWorkflowTaskBackoff ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_uniqueStorage()._firstWorkflowTaskBackoff = newValue}
    }
    /// Returns true if `firstWorkflowTaskBackoff` has been explicitly set.
    public var hasFirstWorkflowTaskBackoff: Bool {_storage._firstWorkflowTaskBackoff != nil}
    /// Clears the value of `firstWorkflowTaskBackoff`. Subsequent reads from it will return its default value.
    public mutating func clearFirstWorkflowTaskBackoff() {_uniqueStorage()._firstWorkflowTaskBackoff = nil}
    ...
    public var prevAutoResetPoints: Api.Workflow.V1.ResetPoints {
      get {_storage._prevAutoResetPoints ?? Api.Workflow.V1.ResetPoints()}
      set {_uniqueStorage()._prevAutoResetPoints = newValue}
    }
    /// Returns true if `prevAutoResetPoints` has been explicitly set.
    public var hasPrevAutoResetPoints: Bool {_storage._prevAutoResetPoints != nil}
    /// Clears the value of `prevAutoResetPoints`. Subsequent reads from it will return its default value.
    public mutating func clearPrevAutoResetPoints() {_uniqueStorage()._prevAutoResetPoints = nil}
    ...
    public var parentInitiatedEventVersion: Int64 {
      get {_storage._parentInitiatedEventVersion}
    ...
    public var sourceVersionStamp: Api.Common.V1.WorkerVersionStamp {
      get {_storage._sourceVersionStamp ?? Api.Common.V1.WorkerVersionStamp()}
      set {_uniqueStorage()._sourceVersionStamp = newValue}
    }
    /// Returns true if `sourceVersionStamp` has been explicitly set.
    public var hasSourceVersionStamp: Bool {_storage._sourceVersionStamp != nil}
    /// Clears the value of `sourceVersionStamp`. Subsequent reads from it will return its default value.
    public mutating func clearSourceVersionStamp() {_uniqueStorage()._sourceVersionStamp = nil}
    ...
    ///     - The root workflow of W1 is W1 and the root workflow of W2 is W2.
    ///     - W1 and W2 have root_workflow_execution set to nil.
    public var rootWorkflowExecution: Api.Common.V1.WorkflowExecution {
      get {_storage._rootWorkflowExecution ?? Api.Common.V1.WorkflowExecution()}
      set {_uniqueStorage()._rootWorkflowExecution = newValue}
    }
    /// Returns true if `rootWorkflowExecution` has been explicitly set.
    public var hasRootWorkflowExecution: Bool {_storage._rootWorkflowExecution != nil}
    /// Clears the value of `rootWorkflowExecution`. Subsequent reads from it will return its default value.
    public mutating func clearRootWorkflowExecution() {_uniqueStorage()._rootWorkflowExecution = nil}
    ...
    public var parentPinnedWorkerDeploymentVersion: String {
      get {_storage._parentPinnedWorkerDeploymentVersion}
    ...
    public var inheritedPinnedVersion: Api.Deployment.V1.WorkerDeploymentVersion {
      get {_storage._inheritedPinnedVersion ?? Api.Deployment.V1.WorkerDeploymentVersion()}
      set {_uniqueStorage()._inheritedPinnedVersion = newValue}
    }
    /// Returns true if `inheritedPinnedVersion` has been explicitly set.
    public var hasInheritedPinnedVersion: Bool {_storage._inheritedPinnedVersion != nil}
    /// Clears the value of `inheritedPinnedVersion`. Subsequent reads from it will return its default value.
    public mutating func clearInheritedPinnedVersion() {_uniqueStorage()._inheritedPinnedVersion = nil}
    ...
    public var inheritedAutoUpgradeInfo: Api.Deployment.V1.InheritedAutoUpgradeInfo {
      get {_storage._inheritedAutoUpgradeInfo ?? Api.Deployment.V1.InheritedAutoUpgradeInfo()}
      set {_uniqueStorage()._inheritedAutoUpgradeInfo = newValue}
    }
    /// Returns true if `inheritedAutoUpgradeInfo` has been explicitly set.
    public var hasInheritedAutoUpgradeInfo: Bool {_storage._inheritedAutoUpgradeInfo != nil}
    /// Clears the value of `inheritedAutoUpgradeInfo`. Subsequent reads from it will return its default value.
    public mutating func clearInheritedAutoUpgradeInfo() {_uniqueStorage()._inheritedAutoUpgradeInfo = nil}
    ...
    public var eagerExecutionAccepted: Bool {
      get {_storage._eagerExecutionAccepted}
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionCompletedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var workflowTaskCompletedEventID: Int64 = 0

    /// If another run is started by cron, this contains the new run id.
    public var newExecutionRunID: String = String()
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionTimedOutEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionContinuedAsNewEventAttributes: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var newExecutionRunID: String {
      get {_storage._newExecutionRunID}
    ...
    public var workflowTaskCompletedEventID: Int64 {
      get {_storage._workflowTaskCompletedEventID}
    ...
    public var backoffStartInterval: SwiftProtobuf.Google_Protobuf_Duration {
    ...
    public var hasBackoffStartInterval: Bool {_storage._backoffStartInterval != nil}
    /// Clears the value of `backoffStartInterval`. Subsequent reads from it will return its default value.
    public mutating func clearBackoffStartInterval() {_uniqueStorage()._backoffStartInterval = nil}
    ...
    /// of the previous run.
    public var initialVersioningBehavior: Api.Enums.V1.ContinueAsNewVersioningBehavior {
...
extension Api.History.V1 {
  ...
  public struct WorkflowTaskScheduledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var hasStartToCloseTimeout: Bool {self._startToCloseTimeout != nil}
    /// Clears the value of `startToCloseTimeout`. Subsequent reads from it will return its default value.
    public mutating func clearStartToCloseTimeout() {self._startToCloseTimeout = nil}
...
extension Api.History.V1 {
  ...
  public struct WorkflowTaskStartedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var suggestContinueAsNew: Bool = false
    ...
    public var historySizeBytes: Int64 = 0
    ...
    ///
    /// NOTE: This field was marked as deprecated in the .proto file.
    public var buildIDRedirectCounter: Int64 = 0
...
extension Api.History.V1 {
  ...
  public struct WorkflowTaskCompletedEventAttributes: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    /// NOTE: This field was marked as deprecated in the .proto file.
    public var workerVersion: Api.Common.V1.WorkerVersionStamp {
      get {_storage._workerVersion ?? Api.Common.V1.WorkerVersionStamp()}
      set {_uniqueStorage()._workerVersion = newValue}
    }
    /// Returns true if `workerVersion` has been explicitly set.
    public var hasWorkerVersion: Bool {_storage._workerVersion != nil}
    /// Clears the value of `workerVersion`. Subsequent reads from it will return its default value.
    public mutating func clearWorkerVersion() {_uniqueStorage()._workerVersion = nil}
    ...
    public var workerDeploymentVersion: String {
      get {_storage._workerDeploymentVersion}
...
extension Api.History.V1 {
  ...
  public struct WorkflowTaskTimedOutEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowTaskFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var baseRunID: String = String()

    /// If the workflow is being reset, the new run id.
    public var newRunID: String = String()
    ...
    public var forkEventVersion: Int64 = 0
...
extension Api.History.V1 {
  ...
  public struct ActivityTaskScheduledEventAttributes: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ActivityTaskStartedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var lastFailure: Api.Failure.V1.Failure {
      get {_lastFailure ?? Api.Failure.V1.Failure()}
    ...
    fileprivate var _lastFailure: Api.Failure.V1.Failure? = nil
    fileprivate var _workerVersion: Api.Common.V1.WorkerVersionStamp? = nil
  }
}
extension Api.History.V1 {
  ...
  public struct ActivityTaskCompletedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ActivityTaskFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ActivityTaskTimedOutEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ActivityTaskCancelRequestedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ActivityTaskCanceledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    /// activity
    public var latestCancelRequestedEventID: Int64 = 0
...
extension Api.History.V1 {
  ...
  public struct TimerStartedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// The worker/user assigned id for this timer
    public var timerID: String = String()

    /// How long until this timer fires
    ///
    /// (-- api-linter: core::0140::prepositions=disabled
    ///     aip.dev/not-precedent: "to" is used to indicate interval. --)
    public var startToFireTimeout: SwiftProtobuf.Google_Protobuf_Duration {
    ...
    public var hasStartToFireTimeout: Bool {self._startToFireTimeout != nil}
    /// Clears the value of `startToFireTimeout`. Subsequent reads from it will return its default value.
    public mutating func clearStartToFireTimeout() {self._startToFireTimeout = nil}
...
extension Api.History.V1 {
  ...
  public struct TimerFiredEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct TimerCanceledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionCancelRequestedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var externalInitiatedEventID: Int64 = 0

    public var externalWorkflowExecution: Api.Common.V1.WorkflowExecution {
      get {_externalWorkflowExecution ?? Api.Common.V1.WorkflowExecution()}
      set {_externalWorkflowExecution = newValue}
    }
    /// Returns true if `externalWorkflowExecution` has been explicitly set.
    public var hasExternalWorkflowExecution: Bool {self._externalWorkflowExecution != nil}
    /// Clears the value of `externalWorkflowExecution`. Subsequent reads from it will return its default value.
    public mutating func clearExternalWorkflowExecution() {self._externalWorkflowExecution = nil}
    ...
    fileprivate var _externalWorkflowExecution: Api.Common.V1.WorkflowExecution? = nil
  }
}
extension Api.History.V1 {


  public struct WorkflowExecutionCanceledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct MarkerRecordedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Workers use this to identify the "types" of various markers. Ex: Local activity, side effect.
    public var markerName: String = String()

    /// Serialized information recorded in the marker
    public var details: Dictionary<String,Api.Common.V1.Payloads> = [:]
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionSignaledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    ///
    /// NOTE: This field was marked as deprecated in the .proto file.
    public var skipGenerateWorkflowTask: Bool = false
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionTerminatedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct RequestCancelExternalWorkflowExecutionInitiatedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var childWorkflowOnly: Bool = false
...
extension Api.History.V1 {
  ...
  public struct RequestCancelExternalWorkflowExecutionFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var cause: Api.Enums.V1.CancelExternalWorkflowExecutionFailedCause = .unspecified
...
extension Api.History.V1 {
  ...
  public struct ExternalWorkflowExecutionCancelRequestedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct SignalExternalWorkflowExecutionInitiatedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct SignalExternalWorkflowExecutionFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var cause: Api.Enums.V1.SignalExternalWorkflowExecutionFailedCause = .unspecified
...
extension Api.History.V1 {
  ...
  public struct ExternalWorkflowExecutionSignaledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct UpsertWorkflowSearchAttributesEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowPropertiesModifiedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct StartChildWorkflowExecutionInitiatedEventAttributes: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var parentClosePolicy: Api.Enums.V1.ParentClosePolicy {
...
extension Api.History.V1 {
  ...
  public struct StartChildWorkflowExecutionFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var cause: Api.Enums.V1.StartChildWorkflowExecutionFailedCause = .unspecified
...
extension Api.History.V1 {
  ...
  public struct ChildWorkflowExecutionStartedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ChildWorkflowExecutionCompletedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ChildWorkflowExecutionFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ChildWorkflowExecutionCanceledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ChildWorkflowExecutionTimedOutEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct ChildWorkflowExecutionTerminatedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionOptionsUpdatedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowPropertiesModifiedExternallyEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Not used.
    public var newTaskQueue: String = String()

    /// Not used.
    public var newWorkflowTaskTimeout: SwiftProtobuf.Google_Protobuf_Duration {
      get {_newWorkflowTaskTimeout ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_newWorkflowTaskTimeout = newValue}
    }
    /// Returns true if `newWorkflowTaskTimeout` has been explicitly set.
    public var hasNewWorkflowTaskTimeout: Bool {self._newWorkflowTaskTimeout != nil}
    /// Clears the value of `newWorkflowTaskTimeout`. Subsequent reads from it will return its default value.
    public mutating func clearNewWorkflowTaskTimeout() {self._newWorkflowTaskTimeout = nil}

    /// Not used.
    public var newWorkflowRunTimeout: SwiftProtobuf.Google_Protobuf_Duration {
      get {_newWorkflowRunTimeout ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_newWorkflowRunTimeout = newValue}
    }
    /// Returns true if `newWorkflowRunTimeout` has been explicitly set.
    public var hasNewWorkflowRunTimeout: Bool {self._newWorkflowRunTimeout != nil}
    /// Clears the value of `newWorkflowRunTimeout`. Subsequent reads from it will return its default value.
    public mutating func clearNewWorkflowRunTimeout() {self._newWorkflowRunTimeout = nil}

    /// Not used.
    public var newWorkflowExecutionTimeout: SwiftProtobuf.Google_Protobuf_Duration {
      get {_newWorkflowExecutionTimeout ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_newWorkflowExecutionTimeout = newValue}
    }
    /// Returns true if `newWorkflowExecutionTimeout` has been explicitly set.
    public var hasNewWorkflowExecutionTimeout: Bool {self._newWorkflowExecutionTimeout != nil}
    /// Clears the value of `newWorkflowExecutionTimeout`. Subsequent reads from it will return its default value.
    public mutating func clearNewWorkflowExecutionTimeout() {self._newWorkflowExecutionTimeout = nil}
...
extension Api.History.V1 {
  ...
  public struct ActivityPropertiesModifiedExternallyEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var newRetryPolicy: Api.Common.V1.RetryPolicy {
      get {_newRetryPolicy ?? Api.Common.V1.RetryPolicy()}
      set {_newRetryPolicy = newValue}
    }
    /// Returns true if `newRetryPolicy` has been explicitly set.
    public var hasNewRetryPolicy: Bool {self._newRetryPolicy != nil}
    /// Clears the value of `newRetryPolicy`. Subsequent reads from it will return its default value.
    public mutating func clearNewRetryPolicy() {self._newRetryPolicy = nil}

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _newRetryPolicy: Api.Common.V1.RetryPolicy? = nil
  }
}
extension Api.History.V1 {


  public struct WorkflowExecutionUpdateAcceptedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionUpdateCompletedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var acceptedEventID: Int64 = 0
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionUpdateRejectedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionUpdateAdmittedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var origin: Api.Enums.V1.UpdateAdmittedEventOrigin = .unspecified
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionPausedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct WorkflowExecutionUnpausedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct NexusOperationScheduledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    /// Returns true if `scheduleToCloseTimeout` has been explicitly set.
    public var hasScheduleToCloseTimeout: Bool {self._scheduleToCloseTimeout != nil}
    /// Clears the value of `scheduleToCloseTimeout`. Subsequent reads from it will return its default value.
    public mutating func clearScheduleToCloseTimeout() {self._scheduleToCloseTimeout = nil}
    ...
    public var nexusHeader: Dictionary<String,String> = [:]
    ...
    /// Returns true if `scheduleToStartTimeout` has been explicitly set.
    public var hasScheduleToStartTimeout: Bool {self._scheduleToStartTimeout != nil}
    /// Clears the value of `scheduleToStartTimeout`. Subsequent reads from it will return its default value.
    public mutating func clearScheduleToStartTimeout() {self._scheduleToStartTimeout = nil}
...
extension Api.History.V1 {
  ...
  public struct NexusOperationStartedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct NexusOperationCompletedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct NexusOperationFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct NexusOperationTimedOutEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct NexusOperationCanceledEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct NexusOperationCancelRequestedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct NexusOperationCancelRequestCompletedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// The ID of the `NEXUS_OPERATION_CANCEL_REQUESTED` event.
    public var requestedEventID: Int64 = 0
...
extension Api.History.V1 {
  ...
  public struct NexusOperationCancelRequestFailedEventAttributes: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.History.V1 {
  ...
  public struct HistoryEvent: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var eventType: Api.Enums.V1.EventType {
    ...
    public var workerMayIgnore: Bool {
      get {_storage._workerMayIgnore}
    ...
    public var attributes: OneOf_Attributes? {
      get {return _storage._attributes}
      set {_uniqueStorage()._attributes = newValue}
    }

    public var workflowExecutionStartedEventAttributes: Api.History.V1.WorkflowExecutionStartedEventAttributes {
      get {
        if case .workflowExecutionStartedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionStartedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionStartedEventAttributes(newValue)}
    }

    public var workflowExecutionCompletedEventAttributes: Api.History.V1.WorkflowExecutionCompletedEventAttributes {
      get {
        if case .workflowExecutionCompletedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionCompletedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionCompletedEventAttributes(newValue)}
    }

    public var workflowExecutionFailedEventAttributes: Api.History.V1.WorkflowExecutionFailedEventAttributes {
      get {
        if case .workflowExecutionFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionFailedEventAttributes(newValue)}
    }

    public var workflowExecutionTimedOutEventAttributes: Api.History.V1.WorkflowExecutionTimedOutEventAttributes {
      get {
        if case .workflowExecutionTimedOutEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionTimedOutEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionTimedOutEventAttributes(newValue)}
    }

    public var workflowTaskScheduledEventAttributes: Api.History.V1.WorkflowTaskScheduledEventAttributes {
      get {
        if case .workflowTaskScheduledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowTaskScheduledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowTaskScheduledEventAttributes(newValue)}
    }

    public var workflowTaskStartedEventAttributes: Api.History.V1.WorkflowTaskStartedEventAttributes {
      get {
        if case .workflowTaskStartedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowTaskStartedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowTaskStartedEventAttributes(newValue)}
    }

    public var workflowTaskCompletedEventAttributes: Api.History.V1.WorkflowTaskCompletedEventAttributes {
      get {
        if case .workflowTaskCompletedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowTaskCompletedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowTaskCompletedEventAttributes(newValue)}
    }

    public var workflowTaskTimedOutEventAttributes: Api.History.V1.WorkflowTaskTimedOutEventAttributes {
      get {
        if case .workflowTaskTimedOutEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowTaskTimedOutEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowTaskTimedOutEventAttributes(newValue)}
    }

    public var workflowTaskFailedEventAttributes: Api.History.V1.WorkflowTaskFailedEventAttributes {
      get {
        if case .workflowTaskFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowTaskFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowTaskFailedEventAttributes(newValue)}
    }

    public var activityTaskScheduledEventAttributes: Api.History.V1.ActivityTaskScheduledEventAttributes {
      get {
        if case .activityTaskScheduledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityTaskScheduledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityTaskScheduledEventAttributes(newValue)}
    }

    public var activityTaskStartedEventAttributes: Api.History.V1.ActivityTaskStartedEventAttributes {
      get {
        if case .activityTaskStartedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityTaskStartedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityTaskStartedEventAttributes(newValue)}
    }

    public var activityTaskCompletedEventAttributes: Api.History.V1.ActivityTaskCompletedEventAttributes {
      get {
        if case .activityTaskCompletedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityTaskCompletedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityTaskCompletedEventAttributes(newValue)}
    }

    public var activityTaskFailedEventAttributes: Api.History.V1.ActivityTaskFailedEventAttributes {
      get {
        if case .activityTaskFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityTaskFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityTaskFailedEventAttributes(newValue)}
    }

    public var activityTaskTimedOutEventAttributes: Api.History.V1.ActivityTaskTimedOutEventAttributes {
      get {
        if case .activityTaskTimedOutEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityTaskTimedOutEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityTaskTimedOutEventAttributes(newValue)}
    }

    public var timerStartedEventAttributes: Api.History.V1.TimerStartedEventAttributes {
      get {
        if case .timerStartedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.TimerStartedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .timerStartedEventAttributes(newValue)}
    }

    public var timerFiredEventAttributes: Api.History.V1.TimerFiredEventAttributes {
      get {
        if case .timerFiredEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.TimerFiredEventAttributes()
      }
      set {_uniqueStorage()._attributes = .timerFiredEventAttributes(newValue)}
    }

    public var activityTaskCancelRequestedEventAttributes: Api.History.V1.ActivityTaskCancelRequestedEventAttributes {
      get {
        if case .activityTaskCancelRequestedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityTaskCancelRequestedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityTaskCancelRequestedEventAttributes(newValue)}
    }

    public var activityTaskCanceledEventAttributes: Api.History.V1.ActivityTaskCanceledEventAttributes {
      get {
        if case .activityTaskCanceledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityTaskCanceledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityTaskCanceledEventAttributes(newValue)}
    }

    public var timerCanceledEventAttributes: Api.History.V1.TimerCanceledEventAttributes {
      get {
        if case .timerCanceledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.TimerCanceledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .timerCanceledEventAttributes(newValue)}
    }

    public var markerRecordedEventAttributes: Api.History.V1.MarkerRecordedEventAttributes {
      get {
        if case .markerRecordedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.MarkerRecordedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .markerRecordedEventAttributes(newValue)}
    }

    public var workflowExecutionSignaledEventAttributes: Api.History.V1.WorkflowExecutionSignaledEventAttributes {
      get {
        if case .workflowExecutionSignaledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionSignaledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionSignaledEventAttributes(newValue)}
    }

    public var workflowExecutionTerminatedEventAttributes: Api.History.V1.WorkflowExecutionTerminatedEventAttributes {
      get {
        if case .workflowExecutionTerminatedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionTerminatedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionTerminatedEventAttributes(newValue)}
    }

    public var workflowExecutionCancelRequestedEventAttributes: Api.History.V1.WorkflowExecutionCancelRequestedEventAttributes {
      get {
        if case .workflowExecutionCancelRequestedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionCancelRequestedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionCancelRequestedEventAttributes(newValue)}
    }

    public var workflowExecutionCanceledEventAttributes: Api.History.V1.WorkflowExecutionCanceledEventAttributes {
      get {
        if case .workflowExecutionCanceledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionCanceledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionCanceledEventAttributes(newValue)}
    }

    public var requestCancelExternalWorkflowExecutionInitiatedEventAttributes: Api.History.V1.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes {
      get {
        if case .requestCancelExternalWorkflowExecutionInitiatedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .requestCancelExternalWorkflowExecutionInitiatedEventAttributes(newValue)}
    }

    public var requestCancelExternalWorkflowExecutionFailedEventAttributes: Api.History.V1.RequestCancelExternalWorkflowExecutionFailedEventAttributes {
      get {
        if case .requestCancelExternalWorkflowExecutionFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.RequestCancelExternalWorkflowExecutionFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .requestCancelExternalWorkflowExecutionFailedEventAttributes(newValue)}
    }

    public var externalWorkflowExecutionCancelRequestedEventAttributes: Api.History.V1.ExternalWorkflowExecutionCancelRequestedEventAttributes {
      get {
        if case .externalWorkflowExecutionCancelRequestedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ExternalWorkflowExecutionCancelRequestedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .externalWorkflowExecutionCancelRequestedEventAttributes(newValue)}
    }

    public var workflowExecutionContinuedAsNewEventAttributes: Api.History.V1.WorkflowExecutionContinuedAsNewEventAttributes {
      get {
        if case .workflowExecutionContinuedAsNewEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionContinuedAsNewEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionContinuedAsNewEventAttributes(newValue)}
    }

    public var startChildWorkflowExecutionInitiatedEventAttributes: Api.History.V1.StartChildWorkflowExecutionInitiatedEventAttributes {
      get {
        if case .startChildWorkflowExecutionInitiatedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.StartChildWorkflowExecutionInitiatedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .startChildWorkflowExecutionInitiatedEventAttributes(newValue)}
    }

    public var startChildWorkflowExecutionFailedEventAttributes: Api.History.V1.StartChildWorkflowExecutionFailedEventAttributes {
      get {
        if case .startChildWorkflowExecutionFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.StartChildWorkflowExecutionFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .startChildWorkflowExecutionFailedEventAttributes(newValue)}
    }

    public var childWorkflowExecutionStartedEventAttributes: Api.History.V1.ChildWorkflowExecutionStartedEventAttributes {
      get {
        if case .childWorkflowExecutionStartedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ChildWorkflowExecutionStartedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .childWorkflowExecutionStartedEventAttributes(newValue)}
    }

    public var childWorkflowExecutionCompletedEventAttributes: Api.History.V1.ChildWorkflowExecutionCompletedEventAttributes {
      get {
        if case .childWorkflowExecutionCompletedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ChildWorkflowExecutionCompletedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .childWorkflowExecutionCompletedEventAttributes(newValue)}
    }

    public var childWorkflowExecutionFailedEventAttributes: Api.History.V1.ChildWorkflowExecutionFailedEventAttributes {
      get {
        if case .childWorkflowExecutionFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ChildWorkflowExecutionFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .childWorkflowExecutionFailedEventAttributes(newValue)}
    }

    public var childWorkflowExecutionCanceledEventAttributes: Api.History.V1.ChildWorkflowExecutionCanceledEventAttributes {
      get {
        if case .childWorkflowExecutionCanceledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ChildWorkflowExecutionCanceledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .childWorkflowExecutionCanceledEventAttributes(newValue)}
    }

    public var childWorkflowExecutionTimedOutEventAttributes: Api.History.V1.ChildWorkflowExecutionTimedOutEventAttributes {
      get {
        if case .childWorkflowExecutionTimedOutEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ChildWorkflowExecutionTimedOutEventAttributes()
      }
      set {_uniqueStorage()._attributes = .childWorkflowExecutionTimedOutEventAttributes(newValue)}
    }

    public var childWorkflowExecutionTerminatedEventAttributes: Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes {
      get {
        if case .childWorkflowExecutionTerminatedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .childWorkflowExecutionTerminatedEventAttributes(newValue)}
    }

    public var signalExternalWorkflowExecutionInitiatedEventAttributes: Api.History.V1.SignalExternalWorkflowExecutionInitiatedEventAttributes {
      get {
        if case .signalExternalWorkflowExecutionInitiatedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.SignalExternalWorkflowExecutionInitiatedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .signalExternalWorkflowExecutionInitiatedEventAttributes(newValue)}
    }

    public var signalExternalWorkflowExecutionFailedEventAttributes: Api.History.V1.SignalExternalWorkflowExecutionFailedEventAttributes {
      get {
        if case .signalExternalWorkflowExecutionFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.SignalExternalWorkflowExecutionFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .signalExternalWorkflowExecutionFailedEventAttributes(newValue)}
    }

    public var externalWorkflowExecutionSignaledEventAttributes: Api.History.V1.ExternalWorkflowExecutionSignaledEventAttributes {
      get {
        if case .externalWorkflowExecutionSignaledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ExternalWorkflowExecutionSignaledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .externalWorkflowExecutionSignaledEventAttributes(newValue)}
    }

    public var upsertWorkflowSearchAttributesEventAttributes: Api.History.V1.UpsertWorkflowSearchAttributesEventAttributes {
      get {
        if case .upsertWorkflowSearchAttributesEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.UpsertWorkflowSearchAttributesEventAttributes()
      }
      set {_uniqueStorage()._attributes = .upsertWorkflowSearchAttributesEventAttributes(newValue)}
    }

    public var workflowExecutionUpdateAcceptedEventAttributes: Api.History.V1.WorkflowExecutionUpdateAcceptedEventAttributes {
      get {
        if case .workflowExecutionUpdateAcceptedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionUpdateAcceptedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionUpdateAcceptedEventAttributes(newValue)}
    }

    public var workflowExecutionUpdateRejectedEventAttributes: Api.History.V1.WorkflowExecutionUpdateRejectedEventAttributes {
      get {
        if case .workflowExecutionUpdateRejectedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionUpdateRejectedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionUpdateRejectedEventAttributes(newValue)}
    }

    public var workflowExecutionUpdateCompletedEventAttributes: Api.History.V1.WorkflowExecutionUpdateCompletedEventAttributes {
      get {
        if case .workflowExecutionUpdateCompletedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionUpdateCompletedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionUpdateCompletedEventAttributes(newValue)}
    }

    public var workflowPropertiesModifiedExternallyEventAttributes: Api.History.V1.WorkflowPropertiesModifiedExternallyEventAttributes {
      get {
        if case .workflowPropertiesModifiedExternallyEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowPropertiesModifiedExternallyEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowPropertiesModifiedExternallyEventAttributes(newValue)}
    }

    public var activityPropertiesModifiedExternallyEventAttributes: Api.History.V1.ActivityPropertiesModifiedExternallyEventAttributes {
      get {
        if case .activityPropertiesModifiedExternallyEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.ActivityPropertiesModifiedExternallyEventAttributes()
      }
      set {_uniqueStorage()._attributes = .activityPropertiesModifiedExternallyEventAttributes(newValue)}
    }

    public var workflowPropertiesModifiedEventAttributes: Api.History.V1.WorkflowPropertiesModifiedEventAttributes {
      get {
        if case .workflowPropertiesModifiedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowPropertiesModifiedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowPropertiesModifiedEventAttributes(newValue)}
    }

    public var workflowExecutionUpdateAdmittedEventAttributes: Api.History.V1.WorkflowExecutionUpdateAdmittedEventAttributes {
      get {
        if case .workflowExecutionUpdateAdmittedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionUpdateAdmittedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionUpdateAdmittedEventAttributes(newValue)}
    }

    public var nexusOperationScheduledEventAttributes: Api.History.V1.NexusOperationScheduledEventAttributes {
      get {
        if case .nexusOperationScheduledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationScheduledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationScheduledEventAttributes(newValue)}
    }

    public var nexusOperationStartedEventAttributes: Api.History.V1.NexusOperationStartedEventAttributes {
      get {
        if case .nexusOperationStartedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationStartedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationStartedEventAttributes(newValue)}
    }

    public var nexusOperationCompletedEventAttributes: Api.History.V1.NexusOperationCompletedEventAttributes {
      get {
        if case .nexusOperationCompletedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationCompletedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationCompletedEventAttributes(newValue)}
    }

    public var nexusOperationFailedEventAttributes: Api.History.V1.NexusOperationFailedEventAttributes {
      get {
        if case .nexusOperationFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationFailedEventAttributes(newValue)}
    }

    public var nexusOperationCanceledEventAttributes: Api.History.V1.NexusOperationCanceledEventAttributes {
      get {
        if case .nexusOperationCanceledEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationCanceledEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationCanceledEventAttributes(newValue)}
    }

    public var nexusOperationTimedOutEventAttributes: Api.History.V1.NexusOperationTimedOutEventAttributes {
      get {
        if case .nexusOperationTimedOutEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationTimedOutEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationTimedOutEventAttributes(newValue)}
    }

    public var nexusOperationCancelRequestedEventAttributes: Api.History.V1.NexusOperationCancelRequestedEventAttributes {
      get {
        if case .nexusOperationCancelRequestedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationCancelRequestedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationCancelRequestedEventAttributes(newValue)}
    }

    public var workflowExecutionOptionsUpdatedEventAttributes: Api.History.V1.WorkflowExecutionOptionsUpdatedEventAttributes {
      get {
        if case .workflowExecutionOptionsUpdatedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionOptionsUpdatedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionOptionsUpdatedEventAttributes(newValue)}
    }

    public var nexusOperationCancelRequestCompletedEventAttributes: Api.History.V1.NexusOperationCancelRequestCompletedEventAttributes {
      get {
        if case .nexusOperationCancelRequestCompletedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationCancelRequestCompletedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationCancelRequestCompletedEventAttributes(newValue)}
    }

    public var nexusOperationCancelRequestFailedEventAttributes: Api.History.V1.NexusOperationCancelRequestFailedEventAttributes {
      get {
        if case .nexusOperationCancelRequestFailedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.NexusOperationCancelRequestFailedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .nexusOperationCancelRequestFailedEventAttributes(newValue)}
    }

    public var workflowExecutionPausedEventAttributes: Api.History.V1.WorkflowExecutionPausedEventAttributes {
      get {
        if case .workflowExecutionPausedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionPausedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionPausedEventAttributes(newValue)}
    }

    public var workflowExecutionUnpausedEventAttributes: Api.History.V1.WorkflowExecutionUnpausedEventAttributes {
      get {
        if case .workflowExecutionUnpausedEventAttributes(let v)? = _storage._attributes {return v}
        return Api.History.V1.WorkflowExecutionUnpausedEventAttributes()
      }
      set {_uniqueStorage()._attributes = .workflowExecutionUnpausedEventAttributes(newValue)}
    }
    ...
    public enum OneOf_Attributes: Equatable, Sendable {
      ...
      case workflowExecutionTimedOutEventAttributes(Api.History.V1.WorkflowExecutionTimedOutEventAttributes)
      case workflowTaskScheduledEventAttributes(Api.History.V1.WorkflowTaskScheduledEventAttributes)
      case workflowTaskStartedEventAttributes(Api.History.V1.WorkflowTaskStartedEventAttributes)
      case workflowTaskCompletedEventAttributes(Api.History.V1.WorkflowTaskCompletedEventAttributes)
      case workflowTaskTimedOutEventAttributes(Api.History.V1.WorkflowTaskTimedOutEventAttributes)
      case workflowTaskFailedEventAttributes(Api.History.V1.WorkflowTaskFailedEventAttributes)
      case activityTaskScheduledEventAttributes(Api.History.V1.ActivityTaskScheduledEventAttributes)
      case activityTaskStartedEventAttributes(Api.History.V1.ActivityTaskStartedEventAttributes)
      case activityTaskCompletedEventAttributes(Api.History.V1.ActivityTaskCompletedEventAttributes)
      case activityTaskFailedEventAttributes(Api.History.V1.ActivityTaskFailedEventAttributes)
      case activityTaskTimedOutEventAttributes(Api.History.V1.ActivityTaskTimedOutEventAttributes)
      case timerStartedEventAttributes(Api.History.V1.TimerStartedEventAttributes)
      case timerFiredEventAttributes(Api.History.V1.TimerFiredEventAttributes)
      case activityTaskCancelRequestedEventAttributes(Api.History.V1.ActivityTaskCancelRequestedEventAttributes)
      case activityTaskCanceledEventAttributes(Api.History.V1.ActivityTaskCanceledEventAttributes)
      case timerCanceledEventAttributes(Api.History.V1.TimerCanceledEventAttributes)
      case markerRecordedEventAttributes(Api.History.V1.MarkerRecordedEventAttributes)
      case workflowExecutionSignaledEventAttributes(Api.History.V1.WorkflowExecutionSignaledEventAttributes)
      case workflowExecutionTerminatedEventAttributes(Api.History.V1.WorkflowExecutionTerminatedEventAttributes)
      case workflowExecutionCancelRequestedEventAttributes(Api.History.V1.WorkflowExecutionCancelRequestedEventAttributes)
      case workflowExecutionCanceledEventAttributes(Api.History.V1.WorkflowExecutionCanceledEventAttributes)
      case requestCancelExternalWorkflowExecutionInitiatedEventAttributes(Api.History.V1.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes)
      case requestCancelExternalWorkflowExecutionFailedEventAttributes(Api.History.V1.RequestCancelExternalWorkflowExecutionFailedEventAttributes)
      case externalWorkflowExecutionCancelRequestedEventAttributes(Api.History.V1.ExternalWorkflowExecutionCancelRequestedEventAttributes)
      case workflowExecutionContinuedAsNewEventAttributes(Api.History.V1.WorkflowExecutionContinuedAsNewEventAttributes)
      case startChildWorkflowExecutionInitiatedEventAttributes(Api.History.V1.StartChildWorkflowExecutionInitiatedEventAttributes)
      case startChildWorkflowExecutionFailedEventAttributes(Api.History.V1.StartChildWorkflowExecutionFailedEventAttributes)
      case childWorkflowExecutionStartedEventAttributes(Api.History.V1.ChildWorkflowExecutionStartedEventAttributes)
      case childWorkflowExecutionCompletedEventAttributes(Api.History.V1.ChildWorkflowExecutionCompletedEventAttributes)
      case childWorkflowExecutionFailedEventAttributes(Api.History.V1.ChildWorkflowExecutionFailedEventAttributes)
      case childWorkflowExecutionCanceledEventAttributes(Api.History.V1.ChildWorkflowExecutionCanceledEventAttributes)
      case childWorkflowExecutionTimedOutEventAttributes(Api.History.V1.ChildWorkflowExecutionTimedOutEventAttributes)
      case childWorkflowExecutionTerminatedEventAttributes(Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes)
      case signalExternalWorkflowExecutionInitiatedEventAttributes(Api.History.V1.SignalExternalWorkflowExecutionInitiatedEventAttributes)
      case signalExternalWorkflowExecutionFailedEventAttributes(Api.History.V1.SignalExternalWorkflowExecutionFailedEventAttributes)
      case externalWorkflowExecutionSignaledEventAttributes(Api.History.V1.ExternalWorkflowExecutionSignaledEventAttributes)
      case upsertWorkflowSearchAttributesEventAttributes(Api.History.V1.UpsertWorkflowSearchAttributesEventAttributes)
      case workflowExecutionUpdateAcceptedEventAttributes(Api.History.V1.WorkflowExecutionUpdateAcceptedEventAttributes)
      case workflowExecutionUpdateRejectedEventAttributes(Api.History.V1.WorkflowExecutionUpdateRejectedEventAttributes)
      case workflowExecutionUpdateCompletedEventAttributes(Api.History.V1.WorkflowExecutionUpdateCompletedEventAttributes)
      case workflowPropertiesModifiedExternallyEventAttributes(Api.History.V1.WorkflowPropertiesModifiedExternallyEventAttributes)
      case activityPropertiesModifiedExternallyEventAttributes(Api.History.V1.ActivityPropertiesModifiedExternallyEventAttributes)
      case workflowPropertiesModifiedEventAttributes(Api.History.V1.WorkflowPropertiesModifiedEventAttributes)
      case workflowExecutionUpdateAdmittedEventAttributes(Api.History.V1.WorkflowExecutionUpdateAdmittedEventAttributes)
      case nexusOperationScheduledEventAttributes(Api.History.V1.NexusOperationScheduledEventAttributes)
      case nexusOperationStartedEventAttributes(Api.History.V1.NexusOperationStartedEventAttributes)
      case nexusOperationCompletedEventAttributes(Api.History.V1.NexusOperationCompletedEventAttributes)
      case nexusOperationFailedEventAttributes(Api.History.V1.NexusOperationFailedEventAttributes)
      case nexusOperationCanceledEventAttributes(Api.History.V1.NexusOperationCanceledEventAttributes)
      case nexusOperationTimedOutEventAttributes(Api.History.V1.NexusOperationTimedOutEventAttributes)
      case nexusOperationCancelRequestedEventAttributes(Api.History.V1.NexusOperationCancelRequestedEventAttributes)
      case workflowExecutionOptionsUpdatedEventAttributes(Api.History.V1.WorkflowExecutionOptionsUpdatedEventAttributes)
      case nexusOperationCancelRequestCompletedEventAttributes(Api.History.V1.NexusOperationCancelRequestCompletedEventAttributes)
      case nexusOperationCancelRequestFailedEventAttributes(Api.History.V1.NexusOperationCancelRequestFailedEventAttributes)
      case workflowExecutionPausedEventAttributes(Api.History.V1.WorkflowExecutionPausedEventAttributes)
      case workflowExecutionUnpausedEventAttributes(Api.History.V1.WorkflowExecutionUnpausedEventAttributes)
...
extension Api.History.V1 {
  ...
  public struct History: Sendable {
    ...
    public var events: [Api.History.V1.HistoryEvent] = []
...
extension Api.History.V1.WorkflowExecutionStartedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _parentWorkflowExecution: Api.Common.V1.WorkflowExecution? = nil
    ...
    var _prevAutoResetPoints: Api.Workflow.V1.ResetPoints? = nil
    var _header: Api.Common.V1.Header? = nil
    var _parentInitiatedEventVersion: Int64 = 0
    var _workflowID: String = String()
    var _sourceVersionStamp: Api.Common.V1.WorkerVersionStamp? = nil
    var _completionCallbacks: [Api.Common.V1.Callback] = []
    var _rootWorkflowExecution: Api.Common.V1.WorkflowExecution? = nil
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionStartedEventAttributes, rhs: Api.History.V1.WorkflowExecutionStartedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionCompletedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionCompletedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{3}workflow_task_completed_event_id\0\u{3}new_execution_run_id\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionCompletedEventAttributes, rhs: Api.History.V1.WorkflowExecutionCompletedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}failure\0\u{3}retry_state\0\u{3}workflow_task_completed_event_id\0\u{3}new_execution_run_id\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionFailedEventAttributes, rhs: Api.History.V1.WorkflowExecutionFailedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionTimedOutEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionTimedOutEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}retry_state\0\u{3}new_execution_run_id\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionTimedOutEventAttributes, rhs: Api.History.V1.WorkflowExecutionTimedOutEventAttributes) -> Bool {
    if lhs.retryState != rhs.retryState {return false}
    if lhs.newExecutionRunID != rhs.newExecutionRunID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.History.V1.WorkflowExecutionContinuedAsNewEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionContinuedAsNewEventAttributes"
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionContinuedAsNewEventAttributes, rhs: Api.History.V1.WorkflowExecutionContinuedAsNewEventAttributes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.History.V1.WorkflowTaskScheduledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowTaskScheduledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}task_queue\0\u{3}start_to_close_timeout\0\u{1}attempt\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowTaskScheduledEventAttributes, rhs: Api.History.V1.WorkflowTaskScheduledEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowTaskStartedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Api.History.V1.WorkflowTaskStartedEventAttributes, rhs: Api.History.V1.WorkflowTaskStartedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowTaskCompletedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowTaskCompletedEventAttributes"
  ...
  fileprivate class _StorageClass {
    ...
    var _workerVersion: Api.Common.V1.WorkerVersionStamp? = nil
  ...
  public static func ==(lhs: Api.History.V1.WorkflowTaskCompletedEventAttributes, rhs: Api.History.V1.WorkflowTaskCompletedEventAttributes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.History.V1.WorkflowTaskTimedOutEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowTaskTimedOutEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{3}started_event_id\0\u{3}timeout_type\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowTaskTimedOutEventAttributes, rhs: Api.History.V1.WorkflowTaskTimedOutEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
...
extension Api.History.V1.WorkflowTaskFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowTaskFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{3}started_event_id\0\u{1}cause\0\u{1}failure\0\u{1}identity\0\u{3}base_run_id\0\u{3}new_run_id\0\u{3}fork_event_version\0\u{3}binary_checksum\0\u{3}worker_version\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowTaskFailedEventAttributes, rhs: Api.History.V1.WorkflowTaskFailedEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs.startedEventID != rhs.startedEventID {return false}
...
extension Api.History.V1.ActivityTaskScheduledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityTaskScheduledEventAttributes"
  ...
  public static func ==(lhs: Api.History.V1.ActivityTaskScheduledEventAttributes, rhs: Api.History.V1.ActivityTaskScheduledEventAttributes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.History.V1.ActivityTaskStartedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityTaskStartedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{1}identity\0\u{3}request_id\0\u{1}attempt\0\u{3}last_failure\0\u{3}worker_version\0\u{3}build_id_redirect_counter\0")
  ...
  public static func ==(lhs: Api.History.V1.ActivityTaskStartedEventAttributes, rhs: Api.History.V1.ActivityTaskStartedEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs.identity != rhs.identity {return false}
    if lhs.requestID != rhs.requestID {return false}
    if lhs.attempt != rhs.attempt {return false}
...
extension Api.History.V1.ActivityTaskCompletedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityTaskCompletedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{3}scheduled_event_id\0\u{3}started_event_id\0\u{1}identity\0\u{3}worker_version\0")
  ...
  public static func ==(lhs: Api.History.V1.ActivityTaskCompletedEventAttributes, rhs: Api.History.V1.ActivityTaskCompletedEventAttributes) -> Bool {
    if lhs._result != rhs._result {return false}
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs.startedEventID != rhs.startedEventID {return false}
    if lhs.identity != rhs.identity {return false}
...
extension Api.History.V1.ActivityTaskFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityTaskFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}failure\0\u{3}scheduled_event_id\0\u{3}started_event_id\0\u{1}identity\0\u{3}retry_state\0\u{3}worker_version\0")
  ...
  public static func ==(lhs: Api.History.V1.ActivityTaskFailedEventAttributes, rhs: Api.History.V1.ActivityTaskFailedEventAttributes) -> Bool {
    if lhs._failure != rhs._failure {return false}
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs.startedEventID != rhs.startedEventID {return false}
    if lhs.identity != rhs.identity {return false}
...
extension Api.History.V1.ActivityTaskTimedOutEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityTaskTimedOutEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}failure\0\u{3}scheduled_event_id\0\u{3}started_event_id\0\u{3}retry_state\0")
  ...
  public static func ==(lhs: Api.History.V1.ActivityTaskTimedOutEventAttributes, rhs: Api.History.V1.ActivityTaskTimedOutEventAttributes) -> Bool {
    if lhs._failure != rhs._failure {return false}
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs.startedEventID != rhs.startedEventID {return false}
    if lhs.retryState != rhs.retryState {return false}
...
extension Api.History.V1.ActivityTaskCancelRequestedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityTaskCancelRequestedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{3}workflow_task_completed_event_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ActivityTaskCancelRequestedEventAttributes, rhs: Api.History.V1.ActivityTaskCancelRequestedEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.History.V1.ActivityTaskCanceledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityTaskCanceledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}details\0\u{3}latest_cancel_requested_event_id\0\u{3}scheduled_event_id\0\u{3}started_event_id\0\u{1}identity\0\u{3}worker_version\0")
  ...
  public static func ==(lhs: Api.History.V1.ActivityTaskCanceledEventAttributes, rhs: Api.History.V1.ActivityTaskCanceledEventAttributes) -> Bool {
...
extension Api.History.V1.TimerStartedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TimerStartedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}timer_id\0\u{3}start_to_fire_timeout\0\u{3}workflow_task_completed_event_id\0")
  ...
  public static func ==(lhs: Api.History.V1.TimerStartedEventAttributes, rhs: Api.History.V1.TimerStartedEventAttributes) -> Bool {
...
extension Api.History.V1.TimerFiredEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TimerFiredEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}timer_id\0\u{3}started_event_id\0")
  ...
  public static func ==(lhs: Api.History.V1.TimerFiredEventAttributes, rhs: Api.History.V1.TimerFiredEventAttributes) -> Bool {
    if lhs.timerID != rhs.timerID {return false}
    if lhs.startedEventID != rhs.startedEventID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.History.V1.TimerCanceledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TimerCanceledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}timer_id\0\u{3}started_event_id\0\u{3}workflow_task_completed_event_id\0\u{1}identity\0")
  ...
  public static func ==(lhs: Api.History.V1.TimerCanceledEventAttributes, rhs: Api.History.V1.TimerCanceledEventAttributes) -> Bool {
    if lhs.timerID != rhs.timerID {return false}
    if lhs.startedEventID != rhs.startedEventID {return false}
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs.identity != rhs.identity {return false}
...
extension Api.History.V1.WorkflowExecutionCancelRequestedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionCancelRequestedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}cause\0\u{3}external_initiated_event_id\0\u{3}external_workflow_execution\0\u{1}identity\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionCancelRequestedEventAttributes, rhs: Api.History.V1.WorkflowExecutionCancelRequestedEventAttributes) -> Bool {
    if lhs.cause != rhs.cause {return false}
...
extension Api.History.V1.WorkflowExecutionCanceledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionCanceledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}workflow_task_completed_event_id\0\u{1}details\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionCanceledEventAttributes, rhs: Api.History.V1.WorkflowExecutionCanceledEventAttributes) -> Bool {
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs._details != rhs._details {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.History.V1.MarkerRecordedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MarkerRecordedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}marker_name\0\u{1}details\0\u{3}workflow_task_completed_event_id\0\u{1}header\0\u{1}failure\0")
  ...
  public static func ==(lhs: Api.History.V1.MarkerRecordedEventAttributes, rhs: Api.History.V1.MarkerRecordedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionSignaledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionSignaledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}signal_name\0\u{1}input\0\u{1}identity\0\u{1}header\0\u{3}skip_generate_workflow_task\0\u{3}external_workflow_execution\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionSignaledEventAttributes, rhs: Api.History.V1.WorkflowExecutionSignaledEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionTerminatedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionTerminatedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}reason\0\u{1}details\0\u{1}identity\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionTerminatedEventAttributes, rhs: Api.History.V1.WorkflowExecutionTerminatedEventAttributes) -> Bool {
...
extension Api.History.V1.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RequestCancelExternalWorkflowExecutionInitiatedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}workflow_task_completed_event_id\0\u{1}namespace\0\u{3}workflow_execution\0\u{1}control\0\u{3}child_workflow_only\0\u{1}reason\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes, rhs: Api.History.V1.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes) -> Bool {
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
...
extension Api.History.V1.RequestCancelExternalWorkflowExecutionFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RequestCancelExternalWorkflowExecutionFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}cause\0\u{3}workflow_task_completed_event_id\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}initiated_event_id\0\u{1}control\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.RequestCancelExternalWorkflowExecutionFailedEventAttributes, rhs: Api.History.V1.RequestCancelExternalWorkflowExecutionFailedEventAttributes) -> Bool {
    if lhs.cause != rhs.cause {return false}
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
...
extension Api.History.V1.ExternalWorkflowExecutionCancelRequestedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ExternalWorkflowExecutionCancelRequestedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}initiated_event_id\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ExternalWorkflowExecutionCancelRequestedEventAttributes, rhs: Api.History.V1.ExternalWorkflowExecutionCancelRequestedEventAttributes) -> Bool {
    if lhs.initiatedEventID != rhs.initiatedEventID {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
...
extension Api.History.V1.SignalExternalWorkflowExecutionInitiatedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SignalExternalWorkflowExecutionInitiatedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}workflow_task_completed_event_id\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}signal_name\0\u{1}input\0\u{1}control\0\u{3}child_workflow_only\0\u{1}header\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.SignalExternalWorkflowExecutionInitiatedEventAttributes, rhs: Api.History.V1.SignalExternalWorkflowExecutionInitiatedEventAttributes) -> Bool {
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
...
extension Api.History.V1.SignalExternalWorkflowExecutionFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SignalExternalWorkflowExecutionFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}cause\0\u{3}workflow_task_completed_event_id\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}initiated_event_id\0\u{1}control\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.SignalExternalWorkflowExecutionFailedEventAttributes, rhs: Api.History.V1.SignalExternalWorkflowExecutionFailedEventAttributes) -> Bool {
    if lhs.cause != rhs.cause {return false}
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
...
extension Api.History.V1.ExternalWorkflowExecutionSignaledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ExternalWorkflowExecutionSignaledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}initiated_event_id\0\u{1}namespace\0\u{3}workflow_execution\0\u{1}control\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ExternalWorkflowExecutionSignaledEventAttributes, rhs: Api.History.V1.ExternalWorkflowExecutionSignaledEventAttributes) -> Bool {
    if lhs.initiatedEventID != rhs.initiatedEventID {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
...
extension Api.History.V1.UpsertWorkflowSearchAttributesEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UpsertWorkflowSearchAttributesEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}workflow_task_completed_event_id\0\u{3}search_attributes\0")
  ...
  public static func ==(lhs: Api.History.V1.UpsertWorkflowSearchAttributesEventAttributes, rhs: Api.History.V1.UpsertWorkflowSearchAttributesEventAttributes) -> Bool {
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
...
extension Api.History.V1.WorkflowPropertiesModifiedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowPropertiesModifiedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}workflow_task_completed_event_id\0\u{3}upserted_memo\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowPropertiesModifiedEventAttributes, rhs: Api.History.V1.WorkflowPropertiesModifiedEventAttributes) -> Bool {
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
...
extension Api.History.V1.StartChildWorkflowExecutionInitiatedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StartChildWorkflowExecutionInitiatedEventAttributes"
  ...
  public static func ==(lhs: Api.History.V1.StartChildWorkflowExecutionInitiatedEventAttributes, rhs: Api.History.V1.StartChildWorkflowExecutionInitiatedEventAttributes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.History.V1.StartChildWorkflowExecutionFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StartChildWorkflowExecutionFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}namespace\0\u{3}workflow_id\0\u{3}workflow_type\0\u{1}cause\0\u{1}control\0\u{3}initiated_event_id\0\u{3}workflow_task_completed_event_id\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.StartChildWorkflowExecutionFailedEventAttributes, rhs: Api.History.V1.StartChildWorkflowExecutionFailedEventAttributes) -> Bool {
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
...
extension Api.History.V1.ChildWorkflowExecutionStartedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ChildWorkflowExecutionStartedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}namespace\0\u{3}initiated_event_id\0\u{3}workflow_execution\0\u{3}workflow_type\0\u{1}header\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ChildWorkflowExecutionStartedEventAttributes, rhs: Api.History.V1.ChildWorkflowExecutionStartedEventAttributes) -> Bool {
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs.initiatedEventID != rhs.initiatedEventID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
...
extension Api.History.V1.ChildWorkflowExecutionCompletedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ChildWorkflowExecutionCompletedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}workflow_type\0\u{3}initiated_event_id\0\u{3}started_event_id\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ChildWorkflowExecutionCompletedEventAttributes, rhs: Api.History.V1.ChildWorkflowExecutionCompletedEventAttributes) -> Bool {
    if lhs._result != rhs._result {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
...
extension Api.History.V1.ChildWorkflowExecutionFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ChildWorkflowExecutionFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}failure\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}workflow_type\0\u{3}initiated_event_id\0\u{3}started_event_id\0\u{3}retry_state\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ChildWorkflowExecutionFailedEventAttributes, rhs: Api.History.V1.ChildWorkflowExecutionFailedEventAttributes) -> Bool {
    if lhs._failure != rhs._failure {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
...
extension Api.History.V1.ChildWorkflowExecutionCanceledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ChildWorkflowExecutionCanceledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}details\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}workflow_type\0\u{3}initiated_event_id\0\u{3}started_event_id\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ChildWorkflowExecutionCanceledEventAttributes, rhs: Api.History.V1.ChildWorkflowExecutionCanceledEventAttributes) -> Bool {
    if lhs._details != rhs._details {return false}
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
...
extension Api.History.V1.ChildWorkflowExecutionTimedOutEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ChildWorkflowExecutionTimedOutEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}workflow_type\0\u{3}initiated_event_id\0\u{3}started_event_id\0\u{3}retry_state\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ChildWorkflowExecutionTimedOutEventAttributes, rhs: Api.History.V1.ChildWorkflowExecutionTimedOutEventAttributes) -> Bool {
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
    if lhs._workflowType != rhs._workflowType {return false}
...
extension Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ChildWorkflowExecutionTerminatedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}namespace\0\u{3}workflow_execution\0\u{3}workflow_type\0\u{3}initiated_event_id\0\u{3}started_event_id\0\u{3}namespace_id\0")
  ...
  public static func ==(lhs: Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes, rhs: Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes) -> Bool {
    if lhs.namespace != rhs.namespace {return false}
    if lhs.namespaceID != rhs.namespaceID {return false}
    if lhs._workflowExecution != rhs._workflowExecution {return false}
    if lhs._workflowType != rhs._workflowType {return false}
...
extension Api.History.V1.WorkflowExecutionOptionsUpdatedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionOptionsUpdatedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}versioning_override\0\u{3}unset_versioning_override\0\u{3}attached_request_id\0\u{3}attached_completion_callbacks\0\u{1}identity\0\u{1}priority\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.identity) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._priority) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionOptionsUpdatedEventAttributes, rhs: Api.History.V1.WorkflowExecutionOptionsUpdatedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowPropertiesModifiedExternallyEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowPropertiesModifiedExternallyEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}new_task_queue\0\u{3}new_workflow_task_timeout\0\u{3}new_workflow_run_timeout\0\u{3}new_workflow_execution_timeout\0\u{3}upserted_memo\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowPropertiesModifiedExternallyEventAttributes, rhs: Api.History.V1.WorkflowPropertiesModifiedExternallyEventAttributes) -> Bool {
...
extension Api.History.V1.ActivityPropertiesModifiedExternallyEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActivityPropertiesModifiedExternallyEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{3}new_retry_policy\0")
  ...
  public static func ==(lhs: Api.History.V1.ActivityPropertiesModifiedExternallyEventAttributes, rhs: Api.History.V1.ActivityPropertiesModifiedExternallyEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
...
extension Api.History.V1.WorkflowExecutionUpdateAcceptedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionUpdateAcceptedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}protocol_instance_id\0\u{3}accepted_request_message_id\0\u{3}accepted_request_sequencing_event_id\0\u{3}accepted_request\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionUpdateAcceptedEventAttributes, rhs: Api.History.V1.WorkflowExecutionUpdateAcceptedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionUpdateCompletedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionUpdateCompletedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}meta\0\u{1}outcome\0\u{3}accepted_event_id\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionUpdateCompletedEventAttributes, rhs: Api.History.V1.WorkflowExecutionUpdateCompletedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionUpdateRejectedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionUpdateRejectedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}protocol_instance_id\0\u{3}rejected_request_message_id\0\u{3}rejected_request_sequencing_event_id\0\u{3}rejected_request\0\u{1}failure\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionUpdateRejectedEventAttributes, rhs: Api.History.V1.WorkflowExecutionUpdateRejectedEventAttributes) -> Bool {
    if lhs.protocolInstanceID != rhs.protocolInstanceID {return false}
...
extension Api.History.V1.WorkflowExecutionUpdateAdmittedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionUpdateAdmittedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}request\0\u{1}origin\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionUpdateAdmittedEventAttributes, rhs: Api.History.V1.WorkflowExecutionUpdateAdmittedEventAttributes) -> Bool {
...
extension Api.History.V1.WorkflowExecutionPausedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionPausedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}identity\0\u{1}reason\0\u{3}request_id\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionPausedEventAttributes, rhs: Api.History.V1.WorkflowExecutionPausedEventAttributes) -> Bool {
    if lhs.identity != rhs.identity {return false}
    if lhs.reason != rhs.reason {return false}
    if lhs.requestID != rhs.requestID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.History.V1.WorkflowExecutionUnpausedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkflowExecutionUnpausedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}identity\0\u{1}reason\0\u{3}request_id\0")
  ...
  public static func ==(lhs: Api.History.V1.WorkflowExecutionUnpausedEventAttributes, rhs: Api.History.V1.WorkflowExecutionUnpausedEventAttributes) -> Bool {
    if lhs.identity != rhs.identity {return false}
    if lhs.reason != rhs.reason {return false}
    if lhs.requestID != rhs.requestID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.History.V1.NexusOperationScheduledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationScheduledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}endpoint\0\u{1}service\0\u{1}operation\0\u{1}input\0\u{3}schedule_to_close_timeout\0\u{3}nexus_header\0\u{3}workflow_task_completed_event_id\0\u{3}request_id\0\u{3}endpoint_id\0\u{3}schedule_to_start_timeout\0\u{3}start_to_close_timeout\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularMessageField(value: &self._scheduleToStartTimeout) }()
      case 11: try { try decoder.decodeSingularMessageField(value: &self._startToCloseTimeout) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationScheduledEventAttributes, rhs: Api.History.V1.NexusOperationScheduledEventAttributes) -> Bool {
...
extension Api.History.V1.NexusOperationStartedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationStartedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{4}\u{2}operation_id\0\u{3}request_id\0\u{3}operation_token\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationStartedEventAttributes, rhs: Api.History.V1.NexusOperationStartedEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
...
extension Api.History.V1.NexusOperationCompletedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationCompletedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{1}result\0\u{3}request_id\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationCompletedEventAttributes, rhs: Api.History.V1.NexusOperationCompletedEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs._result != rhs._result {return false}
    if lhs.requestID != rhs.requestID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.History.V1.NexusOperationFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{1}failure\0\u{3}request_id\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationFailedEventAttributes, rhs: Api.History.V1.NexusOperationFailedEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs._failure != rhs._failure {return false}
    if lhs.requestID != rhs.requestID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.History.V1.NexusOperationTimedOutEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationTimedOutEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{1}failure\0\u{3}request_id\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationTimedOutEventAttributes, rhs: Api.History.V1.NexusOperationTimedOutEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs._failure != rhs._failure {return false}
    if lhs.requestID != rhs.requestID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.History.V1.NexusOperationCanceledEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationCanceledEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{1}failure\0\u{3}request_id\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationCanceledEventAttributes, rhs: Api.History.V1.NexusOperationCanceledEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs._failure != rhs._failure {return false}
    if lhs.requestID != rhs.requestID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Api.History.V1.NexusOperationCancelRequestedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationCancelRequestedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}scheduled_event_id\0\u{3}workflow_task_completed_event_id\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationCancelRequestedEventAttributes, rhs: Api.History.V1.NexusOperationCancelRequestedEventAttributes) -> Bool {
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api.History.V1.NexusOperationCancelRequestCompletedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationCancelRequestCompletedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}requested_event_id\0\u{3}workflow_task_completed_event_id\0\u{3}scheduled_event_id\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationCancelRequestCompletedEventAttributes, rhs: Api.History.V1.NexusOperationCancelRequestCompletedEventAttributes) -> Bool {
...
extension Api.History.V1.NexusOperationCancelRequestFailedEventAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NexusOperationCancelRequestFailedEventAttributes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}requested_event_id\0\u{3}workflow_task_completed_event_id\0\u{1}failure\0\u{3}scheduled_event_id\0")
  ...
  public static func ==(lhs: Api.History.V1.NexusOperationCancelRequestFailedEventAttributes, rhs: Api.History.V1.NexusOperationCancelRequestFailedEventAttributes) -> Bool {
    if lhs.requestedEventID != rhs.requestedEventID {return false}
    if lhs.workflowTaskCompletedEventID != rhs.workflowTaskCompletedEventID {return false}
    if lhs._failure != rhs._failure {return false}
    if lhs.scheduledEventID != rhs.scheduledEventID {return false}
...
extension Api.History.V1.HistoryEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _attributes: Api.History.V1.HistoryEvent.OneOf_Attributes?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try {
          var v: Api.History.V1.WorkflowExecutionStartedEventAttributes?
        ...
        case 7: try {
          var v: Api.History.V1.WorkflowExecutionCompletedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 8: try {
          var v: Api.History.V1.WorkflowExecutionFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 9: try {
          var v: Api.History.V1.WorkflowExecutionTimedOutEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 10: try {
          var v: Api.History.V1.WorkflowTaskScheduledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 11: try {
          var v: Api.History.V1.WorkflowTaskStartedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 12: try {
          var v: Api.History.V1.WorkflowTaskCompletedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 13: try {
          var v: Api.History.V1.WorkflowTaskTimedOutEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 14: try {
          var v: Api.History.V1.WorkflowTaskFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 15: try {
          var v: Api.History.V1.ActivityTaskScheduledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 16: try {
          var v: Api.History.V1.ActivityTaskStartedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 17: try {
          var v: Api.History.V1.ActivityTaskCompletedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 18: try {
          var v: Api.History.V1.ActivityTaskFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 19: try {
          var v: Api.History.V1.ActivityTaskTimedOutEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 20: try {
          var v: Api.History.V1.TimerStartedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 21: try {
          var v: Api.History.V1.TimerFiredEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 22: try {
          var v: Api.History.V1.ActivityTaskCancelRequestedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 23: try {
          var v: Api.History.V1.ActivityTaskCanceledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 24: try {
          var v: Api.History.V1.TimerCanceledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 25: try {
          var v: Api.History.V1.MarkerRecordedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 26: try {
          var v: Api.History.V1.WorkflowExecutionSignaledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 27: try {
          var v: Api.History.V1.WorkflowExecutionTerminatedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 28: try {
          var v: Api.History.V1.WorkflowExecutionCancelRequestedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 29: try {
          var v: Api.History.V1.WorkflowExecutionCanceledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 30: try {
          var v: Api.History.V1.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 31: try {
          var v: Api.History.V1.RequestCancelExternalWorkflowExecutionFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 32: try {
          var v: Api.History.V1.ExternalWorkflowExecutionCancelRequestedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 33: try {
          var v: Api.History.V1.WorkflowExecutionContinuedAsNewEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 34: try {
          var v: Api.History.V1.StartChildWorkflowExecutionInitiatedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 35: try {
          var v: Api.History.V1.StartChildWorkflowExecutionFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 36: try {
          var v: Api.History.V1.ChildWorkflowExecutionStartedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 37: try {
          var v: Api.History.V1.ChildWorkflowExecutionCompletedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 38: try {
          var v: Api.History.V1.ChildWorkflowExecutionFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 39: try {
          var v: Api.History.V1.ChildWorkflowExecutionCanceledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 40: try {
          var v: Api.History.V1.ChildWorkflowExecutionTimedOutEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 41: try {
          var v: Api.History.V1.ChildWorkflowExecutionTerminatedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 42: try {
          var v: Api.History.V1.SignalExternalWorkflowExecutionInitiatedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 43: try {
          var v: Api.History.V1.SignalExternalWorkflowExecutionFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 44: try {
          var v: Api.History.V1.ExternalWorkflowExecutionSignaledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 45: try {
          var v: Api.History.V1.UpsertWorkflowSearchAttributesEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 46: try {
          var v: Api.History.V1.WorkflowExecutionUpdateAcceptedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 47: try {
          var v: Api.History.V1.WorkflowExecutionUpdateRejectedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 48: try {
          var v: Api.History.V1.WorkflowExecutionUpdateCompletedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 49: try {
          var v: Api.History.V1.WorkflowPropertiesModifiedExternallyEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 50: try {
          var v: Api.History.V1.ActivityPropertiesModifiedExternallyEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 51: try {
          var v: Api.History.V1.WorkflowPropertiesModifiedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 52: try {
          var v: Api.History.V1.WorkflowExecutionUpdateAdmittedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 53: try {
          var v: Api.History.V1.NexusOperationScheduledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 54: try {
          var v: Api.History.V1.NexusOperationStartedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 55: try {
          var v: Api.History.V1.NexusOperationCompletedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 56: try {
          var v: Api.History.V1.NexusOperationFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 57: try {
          var v: Api.History.V1.NexusOperationCanceledEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 58: try {
          var v: Api.History.V1.NexusOperationTimedOutEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 59: try {
          var v: Api.History.V1.NexusOperationCancelRequestedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 60: try {
          var v: Api.History.V1.WorkflowExecutionOptionsUpdatedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 61: try {
          var v: Api.History.V1.NexusOperationCancelRequestCompletedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 62: try {
          var v: Api.History.V1.NexusOperationCancelRequestFailedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
        ...
        case 63: try {
          var v: Api.History.V1.WorkflowExecutionPausedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
            if case .workflowExecutionPausedEventAttributes(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._attributes = .workflowExecutionPausedEventAttributes(v)
          }
        }()
        case 64: try {
          var v: Api.History.V1.WorkflowExecutionUnpausedEventAttributes?
          var hadOneofValue = false
          if let current = _storage._attributes {
            hadOneofValue = true
            if case .workflowExecutionUnpausedEventAttributes(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._attributes = .workflowExecutionUnpausedEventAttributes(v)
          }
        }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .workflowExecutionPausedEventAttributes?: try {
        guard case .workflowExecutionPausedEventAttributes(let v)? = _storage._attributes else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 63)
      }()
      case .workflowExecutionUnpausedEventAttributes?: try {
        guard case .workflowExecutionUnpausedEventAttributes(let v)? = _storage._attributes else { preconditionFailure() }
  ...
  public static func ==(lhs: Api.History.V1.HistoryEvent, rhs: Api.History.V1.HistoryEvent) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.History.V1.History: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Api.History.V1.History, rhs: Api.History.V1.History) -> Bool {
