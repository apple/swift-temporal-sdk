...
extension Api.Worker.V1 {
  ...
  public struct WorkerPollerInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Number of polling RPCs that are currently in flight.
    public var currentPollers: Int32 = 0

    public var lastSuccessfulPollTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_lastSuccessfulPollTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_lastSuccessfulPollTime = newValue}
    }
    /// Returns true if `lastSuccessfulPollTime` has been explicitly set.
    public var hasLastSuccessfulPollTime: Bool {self._lastSuccessfulPollTime != nil}
    /// Clears the value of `lastSuccessfulPollTime`. Subsequent reads from it will return its default value.
    public mutating func clearLastSuccessfulPollTime() {self._lastSuccessfulPollTime = nil}

    /// Set true if the number of concurrent pollers is auto-scaled
    public var isAutoscaling: Bool = false
...
extension Api.Worker.V1 {
  ...
  public struct WorkerSlotsInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var currentAvailableSlots: Int32 = 0

    /// Number of slots used by the worker for specific tasks.
    public var currentUsedSlots: Int32 = 0
    ...
    public var slotSupplierKind: String = String()
    ...
    public var totalProcessedTasks: Int32 = 0

    /// Total number of failed tasks processed by the worker so far.
    public var totalFailedTasks: Int32 = 0
    ...
    public var lastIntervalProcessedTasks: Int32 = 0

    /// Number of failed tasks processed since the last heartbeat from the worker.
    public var lastIntervalFailureTasks: Int32 = 0
...
extension Api.Worker.V1 {
  ...
  public struct WorkerHostInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Worker.V1 {
  ...
  public struct WorkerHeartbeat: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var workerInstanceKey: String {
      get {_storage._workerInstanceKey}
    ...
    public var workerIdentity: String {
      get {_storage._workerIdentity}
      set {_uniqueStorage()._workerIdentity = newValue}
    }

    /// Worker host information.
    public var hostInfo: Api.Worker.V1.WorkerHostInfo {
      get {_storage._hostInfo ?? Api.Worker.V1.WorkerHostInfo()}
      set {_uniqueStorage()._hostInfo = newValue}
    }
    /// Returns true if `hostInfo` has been explicitly set.
    public var hasHostInfo: Bool {_storage._hostInfo != nil}
    /// Clears the value of `hostInfo`. Subsequent reads from it will return its default value.
    public mutating func clearHostInfo() {_uniqueStorage()._hostInfo = nil}
    ...
    public var status: Api.Enums.V1.WorkerStatus {
    ...
    public var heartbeatTime: SwiftProtobuf.Google_Protobuf_Timestamp {
      get {_storage._heartbeatTime ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
      set {_uniqueStorage()._heartbeatTime = newValue}
    }
    /// Returns true if `heartbeatTime` has been explicitly set.
    public var hasHeartbeatTime: Bool {_storage._heartbeatTime != nil}
    /// Clears the value of `heartbeatTime`. Subsequent reads from it will return its default value.
    public mutating func clearHeartbeatTime() {_uniqueStorage()._heartbeatTime = nil}

    /// Elapsed time since the last heartbeat from the worker.
    public var elapsedSinceLastHeartbeat: SwiftProtobuf.Google_Protobuf_Duration {
      get {_storage._elapsedSinceLastHeartbeat ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_uniqueStorage()._elapsedSinceLastHeartbeat = newValue}
    }
    /// Returns true if `elapsedSinceLastHeartbeat` has been explicitly set.
    public var hasElapsedSinceLastHeartbeat: Bool {_storage._elapsedSinceLastHeartbeat != nil}
    /// Clears the value of `elapsedSinceLastHeartbeat`. Subsequent reads from it will return its default value.
    public mutating func clearElapsedSinceLastHeartbeat() {_uniqueStorage()._elapsedSinceLastHeartbeat = nil}

    public var workflowTaskSlotsInfo: Api.Worker.V1.WorkerSlotsInfo {
      get {_storage._workflowTaskSlotsInfo ?? Api.Worker.V1.WorkerSlotsInfo()}
      set {_uniqueStorage()._workflowTaskSlotsInfo = newValue}
    }
    /// Returns true if `workflowTaskSlotsInfo` has been explicitly set.
    public var hasWorkflowTaskSlotsInfo: Bool {_storage._workflowTaskSlotsInfo != nil}
    /// Clears the value of `workflowTaskSlotsInfo`. Subsequent reads from it will return its default value.
    public mutating func clearWorkflowTaskSlotsInfo() {_uniqueStorage()._workflowTaskSlotsInfo = nil}

    public var activityTaskSlotsInfo: Api.Worker.V1.WorkerSlotsInfo {
      get {_storage._activityTaskSlotsInfo ?? Api.Worker.V1.WorkerSlotsInfo()}
      set {_uniqueStorage()._activityTaskSlotsInfo = newValue}
    }
    /// Returns true if `activityTaskSlotsInfo` has been explicitly set.
    public var hasActivityTaskSlotsInfo: Bool {_storage._activityTaskSlotsInfo != nil}
    /// Clears the value of `activityTaskSlotsInfo`. Subsequent reads from it will return its default value.
    public mutating func clearActivityTaskSlotsInfo() {_uniqueStorage()._activityTaskSlotsInfo = nil}

    public var nexusTaskSlotsInfo: Api.Worker.V1.WorkerSlotsInfo {
      get {_storage._nexusTaskSlotsInfo ?? Api.Worker.V1.WorkerSlotsInfo()}
      set {_uniqueStorage()._nexusTaskSlotsInfo = newValue}
    }
    /// Returns true if `nexusTaskSlotsInfo` has been explicitly set.
    public var hasNexusTaskSlotsInfo: Bool {_storage._nexusTaskSlotsInfo != nil}
    /// Clears the value of `nexusTaskSlotsInfo`. Subsequent reads from it will return its default value.
    public mutating func clearNexusTaskSlotsInfo() {_uniqueStorage()._nexusTaskSlotsInfo = nil}

    public var localActivitySlotsInfo: Api.Worker.V1.WorkerSlotsInfo {
      get {_storage._localActivitySlotsInfo ?? Api.Worker.V1.WorkerSlotsInfo()}
      set {_uniqueStorage()._localActivitySlotsInfo = newValue}
    }
    /// Returns true if `localActivitySlotsInfo` has been explicitly set.
    public var hasLocalActivitySlotsInfo: Bool {_storage._localActivitySlotsInfo != nil}
    /// Clears the value of `localActivitySlotsInfo`. Subsequent reads from it will return its default value.
    public mutating func clearLocalActivitySlotsInfo() {_uniqueStorage()._localActivitySlotsInfo = nil}

    public var workflowPollerInfo: Api.Worker.V1.WorkerPollerInfo {
      get {_storage._workflowPollerInfo ?? Api.Worker.V1.WorkerPollerInfo()}
      set {_uniqueStorage()._workflowPollerInfo = newValue}
    }
    /// Returns true if `workflowPollerInfo` has been explicitly set.
    public var hasWorkflowPollerInfo: Bool {_storage._workflowPollerInfo != nil}
    /// Clears the value of `workflowPollerInfo`. Subsequent reads from it will return its default value.
    public mutating func clearWorkflowPollerInfo() {_uniqueStorage()._workflowPollerInfo = nil}

    public var workflowStickyPollerInfo: Api.Worker.V1.WorkerPollerInfo {
      get {_storage._workflowStickyPollerInfo ?? Api.Worker.V1.WorkerPollerInfo()}
      set {_uniqueStorage()._workflowStickyPollerInfo = newValue}
    }
    /// Returns true if `workflowStickyPollerInfo` has been explicitly set.
    public var hasWorkflowStickyPollerInfo: Bool {_storage._workflowStickyPollerInfo != nil}
    /// Clears the value of `workflowStickyPollerInfo`. Subsequent reads from it will return its default value.
    public mutating func clearWorkflowStickyPollerInfo() {_uniqueStorage()._workflowStickyPollerInfo = nil}

    public var activityPollerInfo: Api.Worker.V1.WorkerPollerInfo {
      get {_storage._activityPollerInfo ?? Api.Worker.V1.WorkerPollerInfo()}
      set {_uniqueStorage()._activityPollerInfo = newValue}
    }
    /// Returns true if `activityPollerInfo` has been explicitly set.
    public var hasActivityPollerInfo: Bool {_storage._activityPollerInfo != nil}
    /// Clears the value of `activityPollerInfo`. Subsequent reads from it will return its default value.
    public mutating func clearActivityPollerInfo() {_uniqueStorage()._activityPollerInfo = nil}

    public var nexusPollerInfo: Api.Worker.V1.WorkerPollerInfo {
      get {_storage._nexusPollerInfo ?? Api.Worker.V1.WorkerPollerInfo()}
      set {_uniqueStorage()._nexusPollerInfo = newValue}
    }
    /// Returns true if `nexusPollerInfo` has been explicitly set.
    public var hasNexusPollerInfo: Bool {_storage._nexusPollerInfo != nil}
    /// Clears the value of `nexusPollerInfo`. Subsequent reads from it will return its default value.
    public mutating func clearNexusPollerInfo() {_uniqueStorage()._nexusPollerInfo = nil}

    /// A Workflow Task found a cached Workflow Execution to run against.
    public var totalStickyCacheHit: Int32 {
      get {_storage._totalStickyCacheHit}
      set {_uniqueStorage()._totalStickyCacheHit = newValue}
    }

    /// A Workflow Task did not find a cached Workflow execution to run against.
    public var totalStickyCacheMiss: Int32 {
      get {_storage._totalStickyCacheMiss}
      set {_uniqueStorage()._totalStickyCacheMiss = newValue}
    }

    /// Current cache size, expressed in number of Workflow Executions.
    public var currentStickyCacheSize: Int32 {
      get {_storage._currentStickyCacheSize}
...
extension Api.Worker.V1.WorkerPollerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerPollerInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}current_pollers\0\u{3}last_successful_poll_time\0\u{3}is_autoscaling\0")
  ...
  public static func ==(lhs: Api.Worker.V1.WorkerPollerInfo, rhs: Api.Worker.V1.WorkerPollerInfo) -> Bool {
...
extension Api.Worker.V1.WorkerSlotsInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerSlotsInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}current_available_slots\0\u{3}current_used_slots\0\u{3}slot_supplier_kind\0\u{3}total_processed_tasks\0\u{3}total_failed_tasks\0\u{3}last_interval_processed_tasks\0\u{3}last_interval_failure_tasks\0")
  ...
  public static func ==(lhs: Api.Worker.V1.WorkerSlotsInfo, rhs: Api.Worker.V1.WorkerSlotsInfo) -> Bool {
...
extension Api.Worker.V1.WorkerHostInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerHostInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}host_name\0\u{3}process_id\0\u{3}current_host_cpu_usage\0\u{3}current_host_mem_usage\0\u{3}worker_grouping_key\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.workerGroupingKey) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.workerGroupingKey.isEmpty {
      try visitor.visitSingularStringField(value: self.workerGroupingKey, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Api.Worker.V1.WorkerHostInfo, rhs: Api.Worker.V1.WorkerHostInfo) -> Bool {
...
extension Api.Worker.V1.WorkerHeartbeat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _hostInfo: Api.Worker.V1.WorkerHostInfo? = nil
    ...
    var _status: Api.Enums.V1.WorkerStatus = .unspecified
    ...
    var _workflowTaskSlotsInfo: Api.Worker.V1.WorkerSlotsInfo? = nil
    var _activityTaskSlotsInfo: Api.Worker.V1.WorkerSlotsInfo? = nil
    var _nexusTaskSlotsInfo: Api.Worker.V1.WorkerSlotsInfo? = nil
    var _localActivitySlotsInfo: Api.Worker.V1.WorkerSlotsInfo? = nil
    var _workflowPollerInfo: Api.Worker.V1.WorkerPollerInfo? = nil
    var _workflowStickyPollerInfo: Api.Worker.V1.WorkerPollerInfo? = nil
    var _activityPollerInfo: Api.Worker.V1.WorkerPollerInfo? = nil
    var _nexusPollerInfo: Api.Worker.V1.WorkerPollerInfo? = nil
  ...
  public static func ==(lhs: Api.Worker.V1.WorkerHeartbeat, rhs: Api.Worker.V1.WorkerHeartbeat) -> Bool {
...
extension Api.Worker.V1.WorkerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}worker_heartbeat\0")
  ...
  public static func ==(lhs: Api.Worker.V1.WorkerInfo, rhs: Api.Worker.V1.WorkerInfo) -> Bool {
