...
extension Api.Activity.V1 {
  ...
  package struct ActivityExecutionOutcome: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    package var value: Api.Activity.V1.ActivityExecutionOutcome.OneOf_Value? = nil
...
extension Api.Activity.V1 {
  ...
  package struct ActivityOptions: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Api.Activity.V1 {
  ...
  package struct ActivityExecutionInfo: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var status: Api.Enums.V1.ActivityExecutionStatus {
      get {_storage._status}
      set {_uniqueStorage()._status = newValue}
    }

    /// More detailed breakdown of ACTIVITY_EXECUTION_STATUS_RUNNING.
    package var runState: Api.Enums.V1.PendingActivityState {
    ...
    package var hasScheduleTime: Bool {_storage._scheduleTime != nil}
    /// Clears the value of `scheduleTime`. Subsequent reads from it will return its default value.
    package mutating func clearScheduleTime() {_uniqueStorage()._scheduleTime = nil}
    ...
    package var stateSizeBytes: Int64 {
    ...
    package var canceledReason: String {
...
extension Api.Activity.V1 {
  ...
  package struct ActivityExecutionListInfo: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var status: Api.Enums.V1.ActivityExecutionStatus = .unspecified
    ...
    package var stateTransitionCount: Int64 = 0

    /// Updated once on scheduled and once on terminal status.
    package var stateSizeBytes: Int64 = 0
...
extension Api.Activity.V1.ActivityExecutionOutcome: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ActivityExecutionOutcome"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}result\0\u{1}failure\0")
  ...
  package static func ==(lhs: Api.Activity.V1.ActivityExecutionOutcome, rhs: Api.Activity.V1.ActivityExecutionOutcome) -> Bool {
...
extension Api.Activity.V1.ActivityOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}task_queue\0\u{3}schedule_to_close_timeout\0\u{3}schedule_to_start_timeout\0\u{3}start_to_close_timeout\0\u{3}heartbeat_timeout\0\u{3}retry_policy\0\u{1}priority\0")
  ...
  package static func ==(lhs: Api.Activity.V1.ActivityOptions, rhs: Api.Activity.V1.ActivityOptions) -> Bool {
...
extension Api.Activity.V1.ActivityExecutionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ActivityExecutionInfo"
  ...
  package static func ==(lhs: Api.Activity.V1.ActivityExecutionInfo, rhs: Api.Activity.V1.ActivityExecutionInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Api.Activity.V1.ActivityExecutionListInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ActivityExecutionListInfo"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}activity_id\0\u{3}run_id\0\u{3}activity_type\0\u{3}schedule_time\0\u{3}close_time\0\u{1}status\0\u{3}search_attributes\0\u{3}task_queue\0\u{3}state_transition_count\0\u{3}state_size_bytes\0\u{3}execution_duration\0")
  ...
  package static func ==(lhs: Api.Activity.V1.ActivityExecutionListInfo, rhs: Api.Activity.V1.ActivityExecutionListInfo) -> Bool {
