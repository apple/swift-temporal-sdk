...
extension Api.Enums.V1 {
  ...
  package enum UpdateWorkflowExecutionLifecycleStage: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    package static let allCases: [Api.Enums.V1.UpdateWorkflowExecutionLifecycleStage] = [
      .unspecified,
      .admitted,
      .accepted,
      .completed,
...
extension Api.Enums.V1 {
  ...
  package enum UpdateAdmittedEventOrigin: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int
    case unspecified // = 0
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Api.Enums.V1.UpdateAdmittedEventOrigin] = [
      .unspecified,
      .reapply,
    ]
