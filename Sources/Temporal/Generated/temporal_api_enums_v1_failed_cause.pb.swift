...
extension Api.Enums.V1 {
  ...
  public enum WorkflowTaskFailedCause: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Api.Enums.V1.WorkflowTaskFailedCause] = [
      .unspecified,
      .unhandledCommand,
...
extension Api.Enums.V1 {
  ...
  public enum StartChildWorkflowExecutionFailedCause: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.StartChildWorkflowExecutionFailedCause] = [
      .unspecified,
...
extension Api.Enums.V1 {
  ...
  public enum CancelExternalWorkflowExecutionFailedCause: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.CancelExternalWorkflowExecutionFailedCause] = [
      .unspecified,
...
extension Api.Enums.V1 {
  ...
  public enum SignalExternalWorkflowExecutionFailedCause: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.SignalExternalWorkflowExecutionFailedCause] = [
      .unspecified,
      .externalWorkflowExecutionNotFound,
      .namespaceNotFound,
...
extension Api.Enums.V1 {
  ...
  public enum ResourceExhaustedCause: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ResourceExhaustedCause] = [
      .unspecified,
      .rpsLimit,
      .concurrentLimit,
      .systemOverloaded,
...
extension Api.Enums.V1 {
  ...
  public enum ResourceExhaustedScope: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Enums.V1.ResourceExhaustedScope] = [
      .unspecified,
      .namespace,
      .system,
    ]
...
extension Api.Enums.V1.StartChildWorkflowExecutionFailedCause: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0START_CHILD_WORKFLOW_EXECUTION_FAILED_CAUSE_UNSPECIFIED\0\u{1}START_CHILD_WORKFLOW_EXECUTION_FAILED_CAUSE_WORKFLOW_ALREADY_EXISTS\0\u{1}START_CHILD_WORKFLOW_EXECUTION_FAILED_CAUSE_NAMESPACE_NOT_FOUND\0")
}
...
extension Api.Enums.V1.ResourceExhaustedScope: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0RESOURCE_EXHAUSTED_SCOPE_UNSPECIFIED\0\u{1}RESOURCE_EXHAUSTED_SCOPE_NAMESPACE\0\u{1}RESOURCE_EXHAUSTED_SCOPE_SYSTEM\0")
}
