...
extension Api.`Protocol`.V1 {
  ...
  package struct Message: Sendable {
    ...
    package var sequencingID: Api.`Protocol`.V1.Message.OneOf_SequencingID? = nil
...
extension Api.`Protocol`.V1.Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static func ==(lhs: Api.`Protocol`.V1.Message, rhs: Api.`Protocol`.V1.Message) -> Bool {
