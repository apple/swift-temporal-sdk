...
extension Api.Cloud.Usage.V1 {
  ...
  public enum RecordType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Api.Cloud.Usage.V1.RecordType] = [
      .unspecified,
      .actions,
      .activeStorage,
      .retainedStorage,
...
extension Api.Cloud.Usage.V1 {
  ...
  public enum RecordUnit: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Cloud.Usage.V1.RecordUnit] = [
      .unspecified,
      .number,
      .byteSeconds,
    ]
...
extension Api.Cloud.Usage.V1 {
  ...
  public enum GroupByKey: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Api.Cloud.Usage.V1.GroupByKey] = [
      .unspecified,
      .namespace,
    ]
...
extension Api.Cloud.Usage.V1 {
  ...
  public struct Summary: Sendable {
    ...
    public var recordGroups: [Api.Cloud.Usage.V1.RecordGroup] = []
...
extension Api.Cloud.Usage.V1 {
  ...
  public struct RecordGroup: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// GroupBy keys and their values for this record group. Multiple fields are combined with logical AND.
    public var groupBys: [Api.Cloud.Usage.V1.GroupBy] = []

    public var records: [Api.Cloud.Usage.V1.Record] = []
...
extension Api.Cloud.Usage.V1 {
  ...
  public struct GroupBy: Sendable {
    ...
    public var key: Api.Cloud.Usage.V1.GroupByKey = .unspecified
...
extension Api.Cloud.Usage.V1 {
  ...
  public struct Record: Sendable {
    ...
    public var type: Api.Cloud.Usage.V1.RecordType = .unspecified

    public var unit: Api.Cloud.Usage.V1.RecordUnit = .unspecified
...
extension Api.Cloud.Usage.V1.RecordType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0RECORD_TYPE_UNSPECIFIED\0\u{1}RECORD_TYPE_ACTIONS\0\u{1}RECORD_TYPE_ACTIVE_STORAGE\0\u{1}RECORD_TYPE_RETAINED_STORAGE\0")
}

extension Api.Cloud.Usage.V1.RecordUnit: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0RECORD_UNIT_UNSPECIFIED\0\u{1}RECORD_UNIT_NUMBER\0\u{1}RECORD_UNIT_BYTE_SECONDS\0")
}

extension Api.Cloud.Usage.V1.GroupByKey: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0GROUP_BY_KEY_UNSPECIFIED\0\u{1}GROUP_BY_KEY_NAMESPACE\0")
}
...
extension Api.Cloud.Usage.V1.Summary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_time\0\u{3}end_time\0\u{3}record_groups\0\u{1}incomplete\0")
  ...
  public static func ==(lhs: Api.Cloud.Usage.V1.Summary, rhs: Api.Cloud.Usage.V1.Summary) -> Bool {
...
extension Api.Cloud.Usage.V1.RecordGroup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_bys\0\u{1}records\0")
  ...
  public static func ==(lhs: Api.Cloud.Usage.V1.RecordGroup, rhs: Api.Cloud.Usage.V1.RecordGroup) -> Bool {
...
extension Api.Cloud.Usage.V1.GroupBy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Api.Cloud.Usage.V1.GroupBy, rhs: Api.Cloud.Usage.V1.GroupBy) -> Bool {
...
extension Api.Cloud.Usage.V1.Record: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}unit\0\u{1}value\0")
  ...
  public static func ==(lhs: Api.Cloud.Usage.V1.Record, rhs: Api.Cloud.Usage.V1.Record) -> Bool {
