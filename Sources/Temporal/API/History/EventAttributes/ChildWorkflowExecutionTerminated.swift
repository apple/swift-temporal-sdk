...
extension HistoryEvent.Attributes {
    /// Event attributes for when a child workflow execution has been terminated.
    public struct ChildWorkflowExecutionTerminated: Hashable, Sendable {
        ...
        /// Creates event attributes for when a child workflow execution has been terminated.
        public init(
            namespace: String,
            namespaceID: String,
